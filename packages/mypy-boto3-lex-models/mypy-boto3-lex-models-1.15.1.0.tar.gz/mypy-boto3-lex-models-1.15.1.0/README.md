...
[boto3.LexModelBuildingService 1.15.1](https://boto3.amazonaws.com/v1/documentation/api/1.15.1/reference/services/lex-models.html#LexModelBuildingService) service
compatible with
