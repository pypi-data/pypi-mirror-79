...
[boto3.LexModelBuildingService 1.14.61](https://boto3.amazonaws.com/v1/documentation/api/1.14.61/reference/services/lex-models.html#LexModelBuildingService) service
compatible with
