...
class CfnScalingPlan(
    ...
    def __init__(
        ...
        id: str,
        *,
        application_source: typing.Union["ApplicationSourceProperty", aws_cdk.core.IResolvable],
        scaling_instructions: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "ScalingInstructionProperty"]]],
    ) -> None:
    ...
    def application_source(
        self,
        value: typing.Union["ApplicationSourceProperty", aws_cdk.core.IResolvable],
    ) -> None:
    ...
    def scaling_instructions(
        self,
    ) -> typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "ScalingInstructionProperty"]]]:
    ...
    def scaling_instructions(
        self,
        value: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "ScalingInstructionProperty"]]],
    ) -> None:
    ...
    class ScalingInstructionProperty:
        def __init__(
            ...
            *,
            ...
            disable_dynamic_scaling: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]] = None,
