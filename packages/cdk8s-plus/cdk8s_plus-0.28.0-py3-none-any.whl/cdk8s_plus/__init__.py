...
class ConfigMapVolumeOptions:
    def __init__(
        ...
        *,
        ...
        items: typing.Optional[typing.Mapping[str, "PathMapping"]] = None,
...
class Container(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.Container"):
    ...
    def __init__(
        ...
        *,
        ...
        env: typing.Optional[typing.Mapping[str, "EnvValue"]] = None,
...
class DeploymentSpecDefinition(
    metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.DeploymentSpecDefinition"
):
...
class EnvValue(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.EnvValue"):
    ...
    @builtins.classmethod
    def from_process(
        cls, key: str, *, required: typing.Optional[bool] = None
    ) -> "EnvValue":
    ...
    @builtins.classmethod
    def from_secret(
        cls, secret: "ISecret", key: str, *, optional: typing.Optional[bool] = None
    ) -> "EnvValue":
...
class ExposeOptions:
    def __init__(
        self, *, port: jsii.Number, service_type: typing.Optional["ServiceType"] = None
    ) -> None:
...
class JobSpecDefinition(
    metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.JobSpecDefinition"
):
    """
    stability
    :stability: experimental
...
class PodSpecDefinition(
    metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.PodSpecDefinition"
):
...
class ResourceProps:
    def __init__(
        self, *, metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None
    ) -> None:
...
class Secret(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.Secret"):
    ...
    def __init__(
        ...
        id: str,
        *,
        string_data: typing.Optional[typing.Mapping[str, str]] = None,
        metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None,
    ) -> None:
        """
        :param scope: -
...
class ServiceAccount(
    Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.ServiceAccount"
):
    """A service account provides an identity for processes that run in a Pod.
...
class ServiceSpec:
    def __init__(
        ...
        *,
        ...
        external_i_ps: typing.Optional[typing.List[str]] = None,
...
class ServiceSpecDefinition(
    metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.ServiceSpecDefinition"
):
...
class ConfigMapProps(ResourceProps):
    def __init__(
        ...
        *,
        metadata: typing.Optional[cdk8s.ApiObjectMetadata] = None,
        binary_data: typing.Optional[typing.Mapping[str, str]] = None,
