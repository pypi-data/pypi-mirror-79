...
[boto3.ForecastQueryService 1.15.0](https://boto3.amazonaws.com/v1/documentation/api/1.15.0/reference/services/forecastquery.html#ForecastQueryService) service
compatible with
