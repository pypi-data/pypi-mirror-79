...
def retrieve_data(simple_query: str, actions_query: str, actions: tp.List[any], **kwargs) -> DF:
    ...
    if actions:
        ...
        return query_df(query=actions_query, actions=actions, **kwargs)
    else:
        return query_df(query=simple_query, **kwargs)
