...
def run(sql_context: CONTEXT, bot_identity: str,
    ...
    databricks_simple_query_file = params['databricks_simple_query_file']
    databricks_actions_query_file = params['databricks_actions_query_file']

    databricks_simple_query = load_query(databricks_simple_query_file)
    databricks_actions_query = load_query(databricks_actions_query_file)
    ...
    sp_df = retrieve_data(sql_context=sql_context,
                          simple_query=databricks_simple_query,
    ...
    scale_raw_completed_df = complete_scale(scale_raw_df,
