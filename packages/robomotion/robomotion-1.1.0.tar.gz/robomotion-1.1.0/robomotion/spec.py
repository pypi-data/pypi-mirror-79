...
from variable import Variable, InVariable, OptVariable, OutVariable, Credentials, ECategory, _Enum
...
class Spec:
            ...
            if issubclass(cls, Node) and cls is not Node:
                ...
                if len(inputs) + len(inputVars) > 0:
                    ...
                    for input in inputVars:
                        ...
                        name = Spec.lower_first_letter(input.name)
                ...
                if len(outputs) + len(outputVars) > 0:
                    ...
                    for output in outputVars:
                        ...
                        name = Spec.lower_first_letter(output.name)
                ...
                if len(options) + len(optionVars) > 0:
                    ...
                    for option in optionVars:
                        ...
                        name = Spec.lower_first_letter(option.name)
    ...
    def get_inputs(cls) -> []:
        ...
        for key in fields.keys():
            val = fields[key]
            if isinstance(val, Variable) and not isinstance(val, InVariable) and val.input:
                inputs.append(val)
    ...
    def get_outputs(cls) -> []:
        ...
        for key in fields.keys():
            val = fields[key]
            if isinstance(val, Variable) and not isinstance(val, OutVariable) and val.output:
                outputs.append(val)
    ...
    def get_options(cls) -> []:
        ...
        for key in fields.keys():
            val = fields[key]
            if (isinstance(val, Variable) or isinstance(val, Credentials)) and not isinstance(val, OptVariable) and val.option:
                options.append(val)
