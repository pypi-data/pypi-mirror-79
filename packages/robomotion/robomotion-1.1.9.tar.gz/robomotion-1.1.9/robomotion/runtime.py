...
class Runtime:
    ...
    @staticmethod
    def get_variable(variable: Runtime.Variable, ctx: Context):
    ...
    @staticmethod
    def set_variable(variable: Runtime.Variable, ctx: Context, value: object):
        scope = variable.scope
        name = variable.name
