...
def compare_history(tickers,items, \
    ...
    itemlist=[
        ...
        'Net Asset per Share','BasicEPS','DilutedEPS','BasicPE','DilutedPE', \
        #发展潜力
...
def calc_fin_rates(fsdf):
    ...
    #毛利率：销售毛利 / 销售收入净额    
    fs['Gross Profit Margin']=round(fs['GrossProfit']/fs['TotalRevenue'],2)
    #销售净利率：净利润 / 销售收入净额
    fs['Net Profit Margin']=round(fs['NetIncome']/fs['TotalRevenue'],2)
    #成本费用净利率：净利润 / 成本费用总额
