...
def get_balance_sheet(symbol):
    ...
    """
    print("...Searching for balance sheet of",symbol,"\b, please wait")
...
def get_income_statements(symbol):
    ...
    """
    print("...Searching for income statements of",symbol,"\b, please wait")
...
def get_cashflow_statements(symbol):
    ...
    """
    print("...Searching for cashflow statements of",symbol,"\b, please wait")
