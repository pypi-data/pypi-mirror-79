...
below is django-grpc instroduction

add below settings to settings.py
```python
GRPC_PRIVATE_KEY = "" # absolute path for private key
GRPC_CERTIFICATE_CHAIN = "" # absolute path for certificate_chain
GRPC_ROOT_CERTIFICATE = "" # absolute path for grpc_root_cerificate
``` 
