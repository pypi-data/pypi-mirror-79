...
sys.path.append('../')
from common.metaclasses import ServerMetaClass
from common.descriptor import Port
from common.variables import *
from common.utils import send_message, get_message
from common.decorate import login_required

logger = logging.getLogger('server')


class MessageProcessor(threading.Thread, metaclass=ServerMetaClass):
    """
