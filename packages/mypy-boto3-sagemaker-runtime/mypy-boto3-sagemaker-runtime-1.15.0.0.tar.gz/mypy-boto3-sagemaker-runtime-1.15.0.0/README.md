...
[boto3.SageMakerRuntime 1.15.0](https://boto3.amazonaws.com/v1/documentation/api/1.15.0/reference/services/sagemaker-runtime.html#SageMakerRuntime) service
compatible with
