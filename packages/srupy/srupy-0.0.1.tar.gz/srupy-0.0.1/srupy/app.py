...
class SRUpy(object):
    ...
    :param max_retries: Number of retry attempts if an HTTP request fails (default: 0 = request only once). SRUpy will
    ...
    def __init__(self, endpoint,
        ...
        if protocol_version not in ['2.0', '1.2', '1.1']:
            raise ValueError("Invalid protocol version: %s! Must be 2.0, 1.2 or 1.1")
        ...
        if inspect.isclass(iterator) and issubclass(iterator, BaseSRUIterator):
            ...
            raise TypeError(
                "Argument 'iterator' must be subclass of %s" % BaseSRUIterator.__name__)
    ...
    def get_records(self, **kwargs):
        ...
        # Default Wert für z. B. recordSchema wird vom jeweiligen Server festgelegt;
        ...
        params = {
                ...
                'maximumRecords': 10,  # for the sake of multi page browsing, we use 10 as default, however
                # 'recordSchema': 'mods',
