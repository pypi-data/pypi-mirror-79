...
setup(
  name = 'geotolk-tools',         # How you named your package folder (MyLib)
  packages = ['geotolk-tools'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/Fundator/geotolk-tools/archive/v_1.1.tar.gz',    # I explain this later on
