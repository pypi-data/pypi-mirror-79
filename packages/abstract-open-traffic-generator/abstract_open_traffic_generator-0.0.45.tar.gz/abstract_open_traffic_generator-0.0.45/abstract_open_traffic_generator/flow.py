...
class Header(object):
    ...
    def __init__(self, choice=None):
        ...
        if isinstance(choice, (type(None), Custom, Ethernet, Vlan, Ipv4, PfcPause)) is False:
            raise TypeError('choice must be of type: type(None), Custom, Ethernet, Vlan, Ipv4, PfcPause')
