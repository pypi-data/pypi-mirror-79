...
class PortEndpoint(object):
    ...
    def __init__(self, tx_port_name=None, rx_port_names=[], tx_patterns=[]):
        ...
        if isinstance(rx_port_names, (list, type(None))) is True:
            self.rx_port_names = rx_port_names
        else:
...
class Pattern(object):
    ...
    - drilldown_column_name (str): A unique name used to create detailed flow results. When requesting flow results the drilldown_column_name value can be specified as part of the request. Flow result responses will display any requested drilldown_column_name value as part of the columns and rows
    """
    _CHOICE_MAP = {
        'str': 'fixed',
        'list': 'list',
    ...
    def __init__(self, choice=None, drilldown_column_name=None):
        ...
        if isinstance(drilldown_column_name, (str, type(None))) is True:
            self.drilldown_column_name = drilldown_column_name
        else:
            raise TypeError('drilldown_column_name must be an instance of (str, type(None))')
