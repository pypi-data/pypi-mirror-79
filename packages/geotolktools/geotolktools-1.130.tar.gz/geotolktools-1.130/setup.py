...
setup(
  ...
  version = '1.130',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/Fundator/geotolk-tools/archive/v1.13.tar.gz',    # I explain this later on
