...
class AccelerometerRange():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'k2G': AccelerometerRange.k2G, 'k4G': AccelerometerRange.k4G, 'k8G': AccelerometerRange.k8G}
    k2G: hal._wpiHal.AccelerometerRange # value = AccelerometerRange.k2G
    k4G: hal._wpiHal.AccelerometerRange # value = AccelerometerRange.k4G
    k8G: hal._wpiHal.AccelerometerRange # value = AccelerometerRange.k8G
    pass
...
class AllianceStationID():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kRed1': AllianceStationID.kRed1, 'kRed2': AllianceStationID.kRed2, 'kRed3': AllianceStationID.kRed3, 'kBlue1': AllianceStationID.kBlue1, 'kBlue2': AllianceStationID.kBlue2, 'kBlue3': AllianceStationID.kBlue3}
    kBlue1: hal._wpiHal.AllianceStationID # value = AllianceStationID.kBlue1
    kBlue2: hal._wpiHal.AllianceStationID # value = AllianceStationID.kBlue2
    kBlue3: hal._wpiHal.AllianceStationID # value = AllianceStationID.kBlue3
    kRed1: hal._wpiHal.AllianceStationID # value = AllianceStationID.kRed1
    kRed2: hal._wpiHal.AllianceStationID # value = AllianceStationID.kRed2
    kRed3: hal._wpiHal.AllianceStationID # value = AllianceStationID.kRed3
    pass
class AnalogTriggerType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kInWindow': AnalogTriggerType.kInWindow, 'kState': AnalogTriggerType.kState, 'kRisingPulse': AnalogTriggerType.kRisingPulse, 'kFallingPulse': AnalogTriggerType.kFallingPulse}
    kFallingPulse: hal._wpiHal.AnalogTriggerType # value = AnalogTriggerType.kFallingPulse
    kInWindow: hal._wpiHal.AnalogTriggerType # value = AnalogTriggerType.kInWindow
    kRisingPulse: hal._wpiHal.AnalogTriggerType # value = AnalogTriggerType.kRisingPulse
    kState: hal._wpiHal.AnalogTriggerType # value = AnalogTriggerType.kState
    pass
class CANDeviceType():
    """
    The CAN device type.
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kBroadcast': CANDeviceType.kBroadcast, 'kRobotController': CANDeviceType.kRobotController, 'kMotorController': CANDeviceType.kMotorController, 'kRelayController': CANDeviceType.kRelayController, 'kGyroSensor': CANDeviceType.kGyroSensor, 'kAccelerometer': CANDeviceType.kAccelerometer, 'kUltrasonicSensor': CANDeviceType.kUltrasonicSensor, 'kGearToothSensor': CANDeviceType.kGearToothSensor, 'kPowerDistribution': CANDeviceType.kPowerDistribution, 'kPneumatics': CANDeviceType.kPneumatics, 'kMiscellaneous': CANDeviceType.kMiscellaneous, 'kFirmwareUpdate': CANDeviceType.kFirmwareUpdate}
    kAccelerometer: hal._wpiHal.CANDeviceType # value = CANDeviceType.kAccelerometer
    kBroadcast: hal._wpiHal.CANDeviceType # value = CANDeviceType.kBroadcast
    kFirmwareUpdate: hal._wpiHal.CANDeviceType # value = CANDeviceType.kFirmwareUpdate
    kGearToothSensor: hal._wpiHal.CANDeviceType # value = CANDeviceType.kGearToothSensor
    kGyroSensor: hal._wpiHal.CANDeviceType # value = CANDeviceType.kGyroSensor
    kMiscellaneous: hal._wpiHal.CANDeviceType # value = CANDeviceType.kMiscellaneous
    kMotorController: hal._wpiHal.CANDeviceType # value = CANDeviceType.kMotorController
    kPneumatics: hal._wpiHal.CANDeviceType # value = CANDeviceType.kPneumatics
    kPowerDistribution: hal._wpiHal.CANDeviceType # value = CANDeviceType.kPowerDistribution
    kRelayController: hal._wpiHal.CANDeviceType # value = CANDeviceType.kRelayController
    kRobotController: hal._wpiHal.CANDeviceType # value = CANDeviceType.kRobotController
    kUltrasonicSensor: hal._wpiHal.CANDeviceType # value = CANDeviceType.kUltrasonicSensor
    pass
class CANManufacturer():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kBroadcast': CANManufacturer.kBroadcast, 'kNI': CANManufacturer.kNI, 'kLM': CANManufacturer.kLM, 'kDEKA': CANManufacturer.kDEKA, 'kCTRE': CANManufacturer.kCTRE, 'kREV': CANManufacturer.kREV, 'kGrapple': CANManufacturer.kGrapple, 'kMS': CANManufacturer.kMS, 'kTeamUse': CANManufacturer.kTeamUse, 'kKauaiLabs': CANManufacturer.kKauaiLabs, 'kCopperforge': CANManufacturer.kCopperforge, 'kPWF': CANManufacturer.kPWF, 'kStudica': CANManufacturer.kStudica}
    kBroadcast: hal._wpiHal.CANManufacturer # value = CANManufacturer.kBroadcast
    kCTRE: hal._wpiHal.CANManufacturer # value = CANManufacturer.kCTRE
    kCopperforge: hal._wpiHal.CANManufacturer # value = CANManufacturer.kCopperforge
    kDEKA: hal._wpiHal.CANManufacturer # value = CANManufacturer.kDEKA
    kGrapple: hal._wpiHal.CANManufacturer # value = CANManufacturer.kGrapple
    kKauaiLabs: hal._wpiHal.CANManufacturer # value = CANManufacturer.kKauaiLabs
    kLM: hal._wpiHal.CANManufacturer # value = CANManufacturer.kLM
    kMS: hal._wpiHal.CANManufacturer # value = CANManufacturer.kMS
    kNI: hal._wpiHal.CANManufacturer # value = CANManufacturer.kNI
    kPWF: hal._wpiHal.CANManufacturer # value = CANManufacturer.kPWF
    kREV: hal._wpiHal.CANManufacturer # value = CANManufacturer.kREV
    kStudica: hal._wpiHal.CANManufacturer # value = CANManufacturer.kStudica
    kTeamUse: hal._wpiHal.CANManufacturer # value = CANManufacturer.kTeamUse
    pass
...
class CounterMode():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kTwoPulse': CounterMode.kTwoPulse, 'kSemiperiod': CounterMode.kSemiperiod, 'kPulseLength': CounterMode.kPulseLength, 'kExternalDirection': CounterMode.kExternalDirection}
    kExternalDirection: hal._wpiHal.CounterMode # value = CounterMode.kExternalDirection
    kPulseLength: hal._wpiHal.CounterMode # value = CounterMode.kPulseLength
    kSemiperiod: hal._wpiHal.CounterMode # value = CounterMode.kSemiperiod
    kTwoPulse: hal._wpiHal.CounterMode # value = CounterMode.kTwoPulse
    pass
class EncoderEncodingType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    Encoder_k1X: hal._wpiHal.EncoderEncodingType # value = EncoderEncodingType.Encoder_k1X
    Encoder_k2X: hal._wpiHal.EncoderEncodingType # value = EncoderEncodingType.Encoder_k2X
    Encoder_k4X: hal._wpiHal.EncoderEncodingType # value = EncoderEncodingType.Encoder_k4X
    __members__: dict # value = {'Encoder_k1X': EncoderEncodingType.Encoder_k1X, 'Encoder_k2X': EncoderEncodingType.Encoder_k2X, 'Encoder_k4X': EncoderEncodingType.Encoder_k4X}
    pass
class EncoderIndexingType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kResetWhileHigh': EncoderIndexingType.kResetWhileHigh, 'kResetWhileLow': EncoderIndexingType.kResetWhileLow, 'kResetOnFallingEdge': EncoderIndexingType.kResetOnFallingEdge, 'kResetOnRisingEdge': EncoderIndexingType.kResetOnRisingEdge}
    kResetOnFallingEdge: hal._wpiHal.EncoderIndexingType # value = EncoderIndexingType.kResetOnFallingEdge
    kResetOnRisingEdge: hal._wpiHal.EncoderIndexingType # value = EncoderIndexingType.kResetOnRisingEdge
    kResetWhileHigh: hal._wpiHal.EncoderIndexingType # value = EncoderIndexingType.kResetWhileHigh
    kResetWhileLow: hal._wpiHal.EncoderIndexingType # value = EncoderIndexingType.kResetWhileLow
    pass
class HandleEnum():
    """
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    AddressableLED: hal._wpiHal.HandleEnum # value = HandleEnum.AddressableLED
    AnalogGyro: hal._wpiHal.HandleEnum # value = HandleEnum.AnalogGyro
    AnalogInput: hal._wpiHal.HandleEnum # value = HandleEnum.AnalogInput
    AnalogOutput: hal._wpiHal.HandleEnum # value = HandleEnum.AnalogOutput
    AnalogTrigger: hal._wpiHal.HandleEnum # value = HandleEnum.AnalogTrigger
    CAN: hal._wpiHal.HandleEnum # value = HandleEnum.CAN
    Compressor: hal._wpiHal.HandleEnum # value = HandleEnum.Compressor
    Counter: hal._wpiHal.HandleEnum # value = HandleEnum.Counter
    DIO: hal._wpiHal.HandleEnum # value = HandleEnum.DIO
    DMA: hal._wpiHal.HandleEnum # value = HandleEnum.DMA
    DigitalPWM: hal._wpiHal.HandleEnum # value = HandleEnum.DigitalPWM
    DutyCycle: hal._wpiHal.HandleEnum # value = HandleEnum.DutyCycle
    Encoder: hal._wpiHal.HandleEnum # value = HandleEnum.Encoder
    FPGAEncoder: hal._wpiHal.HandleEnum # value = HandleEnum.FPGAEncoder
    Interrupt: hal._wpiHal.HandleEnum # value = HandleEnum.Interrupt
    Notifier: hal._wpiHal.HandleEnum # value = HandleEnum.Notifier
    PWM: hal._wpiHal.HandleEnum # value = HandleEnum.PWM
    Port: hal._wpiHal.HandleEnum # value = HandleEnum.Port
    Relay: hal._wpiHal.HandleEnum # value = HandleEnum.Relay
    SerialPort: hal._wpiHal.HandleEnum # value = HandleEnum.SerialPort
    SimulationJni: hal._wpiHal.HandleEnum # value = HandleEnum.SimulationJni
    Solenoid: hal._wpiHal.HandleEnum # value = HandleEnum.Solenoid
    Undefined: hal._wpiHal.HandleEnum # value = HandleEnum.Undefined
    Vendor: hal._wpiHal.HandleEnum # value = HandleEnum.Vendor
    __members__: dict # value = {'Undefined': HandleEnum.Undefined, 'DIO': HandleEnum.DIO, 'Port': HandleEnum.Port, 'Notifier': HandleEnum.Notifier, 'Interrupt': HandleEnum.Interrupt, 'AnalogOutput': HandleEnum.AnalogOutput, 'AnalogInput': HandleEnum.AnalogInput, 'AnalogTrigger': HandleEnum.AnalogTrigger, 'Relay': HandleEnum.Relay, 'PWM': HandleEnum.PWM, 'DigitalPWM': HandleEnum.DigitalPWM, 'Counter': HandleEnum.Counter, 'FPGAEncoder': HandleEnum.FPGAEncoder, 'Encoder': HandleEnum.Encoder, 'Compressor': HandleEnum.Compressor, 'Solenoid': HandleEnum.Solenoid, 'AnalogGyro': HandleEnum.AnalogGyro, 'Vendor': HandleEnum.Vendor, 'SimulationJni': HandleEnum.SimulationJni, 'CAN': HandleEnum.CAN, 'SerialPort': HandleEnum.SerialPort, 'DutyCycle': HandleEnum.DutyCycle, 'DMA': HandleEnum.DMA, 'AddressableLED': HandleEnum.AddressableLED}
    pass
class I2CPort():
    """
    Members:
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kInvalid': I2CPort.kInvalid, 'kOnboard': I2CPort.kOnboard, 'kMXP': I2CPort.kMXP}
    kInvalid: hal._wpiHal.I2CPort # value = I2CPort.kInvalid
    kMXP: hal._wpiHal.I2CPort # value = I2CPort.kMXP
    kOnboard: hal._wpiHal.I2CPort # value = I2CPort.kOnboard
    pass
class JoystickAxes():
    def __init__(self) -> None: ...
    @property
...
class MatchType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'none': MatchType.none, 'practice': MatchType.practice, 'qualification': MatchType.qualification, 'elimination': MatchType.elimination}
    elimination: hal._wpiHal.MatchType # value = MatchType.elimination
    none: hal._wpiHal.MatchType # value = MatchType.none
    practice: hal._wpiHal.MatchType # value = MatchType.practice
    qualification: hal._wpiHal.MatchType # value = MatchType.qualification
    pass
class RuntimeType():
    """
    Members:
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    HAL_Athena: hal._wpiHal.RuntimeType # value = RuntimeType.HAL_Athena
    HAL_Mock: hal._wpiHal.RuntimeType # value = RuntimeType.HAL_Mock
    __members__: dict # value = {'HAL_Athena': RuntimeType.HAL_Athena, 'HAL_Mock': RuntimeType.HAL_Mock}
    pass
class SPIPort():
    """
    Members:
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kInvalid': SPIPort.kInvalid, 'kOnboardCS0': SPIPort.kOnboardCS0, 'kOnboardCS1': SPIPort.kOnboardCS1, 'kOnboardCS2': SPIPort.kOnboardCS2, 'kOnboardCS3': SPIPort.kOnboardCS3, 'kMXP': SPIPort.kMXP}
    kInvalid: hal._wpiHal.SPIPort # value = SPIPort.kInvalid
    kMXP: hal._wpiHal.SPIPort # value = SPIPort.kMXP
    kOnboardCS0: hal._wpiHal.SPIPort # value = SPIPort.kOnboardCS0
    kOnboardCS1: hal._wpiHal.SPIPort # value = SPIPort.kOnboardCS1
    kOnboardCS2: hal._wpiHal.SPIPort # value = SPIPort.kOnboardCS2
    kOnboardCS3: hal._wpiHal.SPIPort # value = SPIPort.kOnboardCS3
    pass
class SerialPort():
    """
    Members:
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    MXP: hal._wpiHal.SerialPort # value = SerialPort.MXP
    Onboard: hal._wpiHal.SerialPort # value = SerialPort.Onboard
    USB1: hal._wpiHal.SerialPort # value = SerialPort.USB1
    USB2: hal._wpiHal.SerialPort # value = SerialPort.USB2
    __members__: dict # value = {'Onboard': SerialPort.Onboard, 'MXP': SerialPort.MXP, 'USB1': SerialPort.USB1, 'USB2': SerialPort.USB2}
    pass
class SimValue():
    """
...
class SimDevice():
    ...
    def __repr__(self) -> str: ...
    def createBoolean(self, name: str, readonly: bool, initialValue: bool) -> SimBoolean: 
        """
        ...
        """
    def createDouble(self, name: str, readonly: bool, initialValue: float) -> SimDouble: 
        """
        ...
        """
    def createEnum(self, name: str, readonly: bool, options: typing.List[str], initialValue: int) -> SimEnum: 
        """
...
class tInstances():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kLanguage_LabVIEW': tInstances.kLanguage_LabVIEW, 'kLanguage_CPlusPlus': tInstances.kLanguage_CPlusPlus, 'kLanguage_Java': tInstances.kLanguage_Java, 'kLanguage_Python': tInstances.kLanguage_Python, 'kLanguage_DotNet': tInstances.kLanguage_DotNet, 'kLanguage_Kotlin': tInstances.kLanguage_Kotlin, 'kCANPlugin_BlackJagBridge': tInstances.kLanguage_LabVIEW, 'kCANPlugin_2CAN': tInstances.kLanguage_CPlusPlus, 'kFramework_Iterative': tInstances.kLanguage_LabVIEW, 'kFramework_Simple': tInstances.kLanguage_CPlusPlus, 'kFramework_CommandControl': tInstances.kLanguage_Java, 'kFramework_Timed': tInstances.kLanguage_Python, 'kFramework_ROS': tInstances.kLanguage_DotNet, 'kFramework_RobotBuilder': tInstances.kLanguage_Kotlin, 'kRobotDrive_ArcadeStandard': tInstances.kLanguage_LabVIEW, 'kRobotDrive_ArcadeButtonSpin': tInstances.kLanguage_CPlusPlus, 'kRobotDrive_ArcadeRatioCurve': tInstances.kLanguage_Java, 'kRobotDrive_Tank': tInstances.kLanguage_Python, 'kRobotDrive_MecanumPolar': tInstances.kLanguage_DotNet, 'kRobotDrive_MecanumCartesian': tInstances.kLanguage_Kotlin, 'kRobotDrive2_DifferentialArcade': tInstances.kRobotDrive2_DifferentialArcade, 'kRobotDrive2_DifferentialTank': tInstances.kRobotDrive2_DifferentialTank, 'kRobotDrive2_DifferentialCurvature': tInstances.kRobotDrive2_DifferentialCurvature, 'kRobotDrive2_MecanumCartesian': tInstances.kRobotDrive2_MecanumCartesian, 'kRobotDrive2_MecanumPolar': tInstances.kRobotDrive2_MecanumPolar, 'kRobotDrive2_KilloughCartesian': tInstances.kRobotDrive2_KilloughCartesian, 'kRobotDrive2_KilloughPolar': tInstances.kRobotDrive2_KilloughPolar, 'kDriverStationCIO_Analog': tInstances.kLanguage_LabVIEW, 'kDriverStationCIO_DigitalIn': tInstances.kLanguage_CPlusPlus, 'kDriverStationCIO_DigitalOut': tInstances.kLanguage_Java, 'kDriverStationEIO_Acceleration': tInstances.kLanguage_LabVIEW, 'kDriverStationEIO_AnalogIn': tInstances.kLanguage_CPlusPlus, 'kDriverStationEIO_AnalogOut': tInstances.kLanguage_Java, 'kDriverStationEIO_Button': tInstances.kLanguage_Python, 'kDriverStationEIO_LED': tInstances.kLanguage_DotNet, 'kDriverStationEIO_DigitalIn': tInstances.kLanguage_Kotlin, 'kDriverStationEIO_DigitalOut': tInstances.kRobotDrive2_DifferentialArcade, 'kDriverStationEIO_FixedDigitalOut': tInstances.kRobotDrive2_DifferentialTank, 'kDriverStationEIO_PWM': tInstances.kRobotDrive2_DifferentialCurvature, 'kDriverStationEIO_Encoder': tInstances.kRobotDrive2_MecanumCartesian, 'kDriverStationEIO_TouchSlider': tInstances.kRobotDrive2_MecanumPolar, 'kADXL345_SPI': tInstances.kLanguage_LabVIEW, 'kADXL345_I2C': tInstances.kLanguage_CPlusPlus, 'kCommand_Scheduler': tInstances.kLanguage_LabVIEW, 'kCommand2_Scheduler': tInstances.kLanguage_CPlusPlus, 'kSmartDashboard_Instance': tInstances.kLanguage_LabVIEW, 'kKinematics_DifferentialDrive': tInstances.kLanguage_LabVIEW, 'kKinematics_MecanumDrive': tInstances.kLanguage_CPlusPlus, 'kKinematics_SwerveDrive': tInstances.kLanguage_Java, 'kOdometry_DifferentialDrive': tInstances.kLanguage_LabVIEW, 'kOdometry_MecanumDrive': tInstances.kLanguage_CPlusPlus, 'kOdometry_SwerveDrive': tInstances.kLanguage_Java}
    kADXL345_I2C: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kADXL345_SPI: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kCANPlugin_2CAN: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kCANPlugin_BlackJagBridge: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kCommand2_Scheduler: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kCommand_Scheduler: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kDriverStationCIO_Analog: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kDriverStationCIO_DigitalIn: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kDriverStationCIO_DigitalOut: hal._wpiHal.tInstances # value = tInstances.kLanguage_Java
    kDriverStationEIO_Acceleration: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kDriverStationEIO_AnalogIn: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kDriverStationEIO_AnalogOut: hal._wpiHal.tInstances # value = tInstances.kLanguage_Java
    kDriverStationEIO_Button: hal._wpiHal.tInstances # value = tInstances.kLanguage_Python
    kDriverStationEIO_DigitalIn: hal._wpiHal.tInstances # value = tInstances.kLanguage_Kotlin
    kDriverStationEIO_DigitalOut: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_DifferentialArcade
    kDriverStationEIO_Encoder: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_MecanumCartesian
    kDriverStationEIO_FixedDigitalOut: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_DifferentialTank
    kDriverStationEIO_LED: hal._wpiHal.tInstances # value = tInstances.kLanguage_DotNet
    kDriverStationEIO_PWM: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_DifferentialCurvature
    kDriverStationEIO_TouchSlider: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_MecanumPolar
    kFramework_CommandControl: hal._wpiHal.tInstances # value = tInstances.kLanguage_Java
    kFramework_Iterative: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kFramework_ROS: hal._wpiHal.tInstances # value = tInstances.kLanguage_DotNet
    kFramework_RobotBuilder: hal._wpiHal.tInstances # value = tInstances.kLanguage_Kotlin
    kFramework_Simple: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kFramework_Timed: hal._wpiHal.tInstances # value = tInstances.kLanguage_Python
    kKinematics_DifferentialDrive: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kKinematics_MecanumDrive: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kKinematics_SwerveDrive: hal._wpiHal.tInstances # value = tInstances.kLanguage_Java
    kLanguage_CPlusPlus: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kLanguage_DotNet: hal._wpiHal.tInstances # value = tInstances.kLanguage_DotNet
    kLanguage_Java: hal._wpiHal.tInstances # value = tInstances.kLanguage_Java
    kLanguage_Kotlin: hal._wpiHal.tInstances # value = tInstances.kLanguage_Kotlin
    kLanguage_LabVIEW: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kLanguage_Python: hal._wpiHal.tInstances # value = tInstances.kLanguage_Python
    kOdometry_DifferentialDrive: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kOdometry_MecanumDrive: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kOdometry_SwerveDrive: hal._wpiHal.tInstances # value = tInstances.kLanguage_Java
    kRobotDrive2_DifferentialArcade: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_DifferentialArcade
    kRobotDrive2_DifferentialCurvature: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_DifferentialCurvature
    kRobotDrive2_DifferentialTank: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_DifferentialTank
    kRobotDrive2_KilloughCartesian: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_KilloughCartesian
    kRobotDrive2_KilloughPolar: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_KilloughPolar
    kRobotDrive2_MecanumCartesian: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_MecanumCartesian
    kRobotDrive2_MecanumPolar: hal._wpiHal.tInstances # value = tInstances.kRobotDrive2_MecanumPolar
    kRobotDrive_ArcadeButtonSpin: hal._wpiHal.tInstances # value = tInstances.kLanguage_CPlusPlus
    kRobotDrive_ArcadeRatioCurve: hal._wpiHal.tInstances # value = tInstances.kLanguage_Java
    kRobotDrive_ArcadeStandard: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    kRobotDrive_MecanumCartesian: hal._wpiHal.tInstances # value = tInstances.kLanguage_Kotlin
    kRobotDrive_MecanumPolar: hal._wpiHal.tInstances # value = tInstances.kLanguage_DotNet
    kRobotDrive_Tank: hal._wpiHal.tInstances # value = tInstances.kLanguage_Python
    kSmartDashboard_Instance: hal._wpiHal.tInstances # value = tInstances.kLanguage_LabVIEW
    pass
class tResourceType():
    """
    Members:
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kResourceType_Controller': tResourceType.kResourceType_Controller, 'kResourceType_Module': tResourceType.kResourceType_Module, 'kResourceType_Language': tResourceType.kResourceType_Language, 'kResourceType_CANPlugin': tResourceType.kResourceType_CANPlugin, 'kResourceType_Accelerometer': tResourceType.kResourceType_Accelerometer, 'kResourceType_ADXL345': tResourceType.kResourceType_ADXL345, 'kResourceType_AnalogChannel': tResourceType.kResourceType_AnalogChannel, 'kResourceType_AnalogTrigger': tResourceType.kResourceType_AnalogTrigger, 'kResourceType_AnalogTriggerOutput': tResourceType.kResourceType_AnalogTriggerOutput, 'kResourceType_CANJaguar': tResourceType.kResourceType_CANJaguar, 'kResourceType_Compressor': tResourceType.kResourceType_Compressor, 'kResourceType_Counter': tResourceType.kResourceType_Counter, 'kResourceType_Dashboard': tResourceType.kResourceType_Dashboard, 'kResourceType_DigitalInput': tResourceType.kResourceType_DigitalInput, 'kResourceType_DigitalOutput': tResourceType.kResourceType_DigitalOutput, 'kResourceType_DriverStationCIO': tResourceType.kResourceType_DriverStationCIO, 'kResourceType_DriverStationEIO': tResourceType.kResourceType_DriverStationEIO, 'kResourceType_DriverStationLCD': tResourceType.kResourceType_DriverStationLCD, 'kResourceType_Encoder': tResourceType.kResourceType_Encoder, 'kResourceType_GearTooth': tResourceType.kResourceType_GearTooth, 'kResourceType_Gyro': tResourceType.kResourceType_Gyro, 'kResourceType_I2C': tResourceType.kResourceType_I2C, 'kResourceType_Framework': tResourceType.kResourceType_Framework, 'kResourceType_Jaguar': tResourceType.kResourceType_Jaguar, 'kResourceType_Joystick': tResourceType.kResourceType_Joystick, 'kResourceType_Kinect': tResourceType.kResourceType_Kinect, 'kResourceType_KinectStick': tResourceType.kResourceType_KinectStick, 'kResourceType_PIDController': tResourceType.kResourceType_PIDController, 'kResourceType_Preferences': tResourceType.kResourceType_Preferences, 'kResourceType_PWM': tResourceType.kResourceType_PWM, 'kResourceType_Relay': tResourceType.kResourceType_Relay, 'kResourceType_RobotDrive': tResourceType.kResourceType_RobotDrive, 'kResourceType_SerialPort': tResourceType.kResourceType_SerialPort, 'kResourceType_Servo': tResourceType.kResourceType_Servo, 'kResourceType_Solenoid': tResourceType.kResourceType_Solenoid, 'kResourceType_SPI': tResourceType.kResourceType_SPI, 'kResourceType_Task': tResourceType.kResourceType_Task, 'kResourceType_Ultrasonic': tResourceType.kResourceType_Ultrasonic, 'kResourceType_Victor': tResourceType.kResourceType_Victor, 'kResourceType_Button': tResourceType.kResourceType_Button, 'kResourceType_Command': tResourceType.kResourceType_Command, 'kResourceType_AxisCamera': tResourceType.kResourceType_AxisCamera, 'kResourceType_PCVideoServer': tResourceType.kResourceType_PCVideoServer, 'kResourceType_SmartDashboard': tResourceType.kResourceType_SmartDashboard, 'kResourceType_Talon': tResourceType.kResourceType_Talon, 'kResourceType_HiTechnicColorSensor': tResourceType.kResourceType_HiTechnicColorSensor, 'kResourceType_HiTechnicAccel': tResourceType.kResourceType_HiTechnicAccel, 'kResourceType_HiTechnicCompass': tResourceType.kResourceType_HiTechnicCompass, 'kResourceType_SRF08': tResourceType.kResourceType_SRF08, 'kResourceType_AnalogOutput': tResourceType.kResourceType_AnalogOutput, 'kResourceType_VictorSP': tResourceType.kResourceType_VictorSP, 'kResourceType_PWMTalonSRX': tResourceType.kResourceType_PWMTalonSRX, 'kResourceType_CANTalonSRX': tResourceType.kResourceType_CANTalonSRX, 'kResourceType_ADXL362': tResourceType.kResourceType_ADXL362, 'kResourceType_ADXRS450': tResourceType.kResourceType_ADXRS450, 'kResourceType_RevSPARK': tResourceType.kResourceType_RevSPARK, 'kResourceType_MindsensorsSD540': tResourceType.kResourceType_MindsensorsSD540, 'kResourceType_DigitalGlitchFilter': tResourceType.kResourceType_DigitalGlitchFilter, 'kResourceType_ADIS16448': tResourceType.kResourceType_ADIS16448, 'kResourceType_PDP': tResourceType.kResourceType_PDP, 'kResourceType_PCM': tResourceType.kResourceType_PCM, 'kResourceType_PigeonIMU': tResourceType.kResourceType_PigeonIMU, 'kResourceType_NidecBrushless': tResourceType.kResourceType_NidecBrushless, 'kResourceType_CANifier': tResourceType.kResourceType_CANifier, 'kResourceType_TalonFX': tResourceType.kResourceType_TalonFX, 'kResourceType_CTRE_future1': tResourceType.kResourceType_CTRE_future1, 'kResourceType_CTRE_future2': tResourceType.kResourceType_CTRE_future2, 'kResourceType_CTRE_future3': tResourceType.kResourceType_CTRE_future3, 'kResourceType_CTRE_future4': tResourceType.kResourceType_CTRE_future4, 'kResourceType_CTRE_future5': tResourceType.kResourceType_CTRE_future5, 'kResourceType_CTRE_future6': tResourceType.kResourceType_CTRE_future6, 'kResourceType_LinearFilter': tResourceType.kResourceType_LinearFilter, 'kResourceType_XboxController': tResourceType.kResourceType_XboxController, 'kResourceType_UsbCamera': tResourceType.kResourceType_UsbCamera, 'kResourceType_NavX': tResourceType.kResourceType_NavX, 'kResourceType_Pixy': tResourceType.kResourceType_Pixy, 'kResourceType_Pixy2': tResourceType.kResourceType_Pixy2, 'kResourceType_ScanseSweep': tResourceType.kResourceType_ScanseSweep, 'kResourceType_Shuffleboard': tResourceType.kResourceType_Shuffleboard, 'kResourceType_CAN': tResourceType.kResourceType_CAN, 'kResourceType_DigilentDMC60': tResourceType.kResourceType_DigilentDMC60, 'kResourceType_PWMVictorSPX': tResourceType.kResourceType_PWMVictorSPX, 'kResourceType_RevSparkMaxPWM': tResourceType.kResourceType_RevSparkMaxPWM, 'kResourceType_RevSparkMaxCAN': tResourceType.kResourceType_RevSparkMaxCAN, 'kResourceType_ADIS16470': tResourceType.kResourceType_ADIS16470, 'kResourceType_PIDController2': tResourceType.kResourceType_PIDController2, 'kResourceType_ProfiledPIDController': tResourceType.kResourceType_ProfiledPIDController, 'kResourceType_Kinematics': tResourceType.kResourceType_Kinematics, 'kResourceType_Odometry': tResourceType.kResourceType_Odometry, 'kResourceType_Units': tResourceType.kResourceType_Units, 'kResourceType_TrapezoidProfile': tResourceType.kResourceType_TrapezoidProfile, 'kResourceType_DutyCycle': tResourceType.kResourceType_DutyCycle, 'kResourceType_AddressableLEDs': tResourceType.kResourceType_AddressableLEDs, 'kResourceType_FusionVenom': tResourceType.kResourceType_FusionVenom}
    kResourceType_ADIS16448: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_ADIS16448
    kResourceType_ADIS16470: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_ADIS16470
    kResourceType_ADXL345: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_ADXL345
    kResourceType_ADXL362: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_ADXL362
    kResourceType_ADXRS450: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_ADXRS450
    kResourceType_Accelerometer: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Accelerometer
    kResourceType_AddressableLEDs: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_AddressableLEDs
    kResourceType_AnalogChannel: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_AnalogChannel
    kResourceType_AnalogOutput: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_AnalogOutput
    kResourceType_AnalogTrigger: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_AnalogTrigger
    kResourceType_AnalogTriggerOutput: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_AnalogTriggerOutput
    kResourceType_AxisCamera: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_AxisCamera
    kResourceType_Button: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Button
    kResourceType_CAN: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CAN
    kResourceType_CANJaguar: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CANJaguar
    kResourceType_CANPlugin: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CANPlugin
    kResourceType_CANTalonSRX: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CANTalonSRX
    kResourceType_CANifier: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CANifier
    kResourceType_CTRE_future1: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CTRE_future1
    kResourceType_CTRE_future2: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CTRE_future2
    kResourceType_CTRE_future3: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CTRE_future3
    kResourceType_CTRE_future4: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CTRE_future4
    kResourceType_CTRE_future5: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CTRE_future5
    kResourceType_CTRE_future6: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_CTRE_future6
    kResourceType_Command: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Command
    kResourceType_Compressor: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Compressor
    kResourceType_Controller: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Controller
    kResourceType_Counter: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Counter
    kResourceType_Dashboard: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Dashboard
    kResourceType_DigilentDMC60: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_DigilentDMC60
    kResourceType_DigitalGlitchFilter: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_DigitalGlitchFilter
    kResourceType_DigitalInput: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_DigitalInput
    kResourceType_DigitalOutput: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_DigitalOutput
    kResourceType_DriverStationCIO: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_DriverStationCIO
    kResourceType_DriverStationEIO: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_DriverStationEIO
    kResourceType_DriverStationLCD: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_DriverStationLCD
    kResourceType_DutyCycle: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_DutyCycle
    kResourceType_Encoder: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Encoder
    kResourceType_Framework: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Framework
    kResourceType_FusionVenom: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_FusionVenom
    kResourceType_GearTooth: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_GearTooth
    kResourceType_Gyro: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Gyro
    kResourceType_HiTechnicAccel: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_HiTechnicAccel
    kResourceType_HiTechnicColorSensor: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_HiTechnicColorSensor
    kResourceType_HiTechnicCompass: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_HiTechnicCompass
    kResourceType_I2C: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_I2C
    kResourceType_Jaguar: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Jaguar
    kResourceType_Joystick: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Joystick
    kResourceType_Kinect: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Kinect
    kResourceType_KinectStick: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_KinectStick
    kResourceType_Kinematics: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Kinematics
    kResourceType_Language: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Language
    kResourceType_LinearFilter: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_LinearFilter
    kResourceType_MindsensorsSD540: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_MindsensorsSD540
    kResourceType_Module: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Module
    kResourceType_NavX: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_NavX
    kResourceType_NidecBrushless: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_NidecBrushless
    kResourceType_Odometry: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Odometry
    kResourceType_PCM: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PCM
    kResourceType_PCVideoServer: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PCVideoServer
    kResourceType_PDP: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PDP
    kResourceType_PIDController: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PIDController
    kResourceType_PIDController2: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PIDController2
    kResourceType_PWM: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PWM
    kResourceType_PWMTalonSRX: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PWMTalonSRX
    kResourceType_PWMVictorSPX: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PWMVictorSPX
    kResourceType_PigeonIMU: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_PigeonIMU
    kResourceType_Pixy: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Pixy
    kResourceType_Pixy2: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Pixy2
    kResourceType_Preferences: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Preferences
    kResourceType_ProfiledPIDController: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_ProfiledPIDController
    kResourceType_Relay: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Relay
    kResourceType_RevSPARK: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_RevSPARK
    kResourceType_RevSparkMaxCAN: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_RevSparkMaxCAN
    kResourceType_RevSparkMaxPWM: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_RevSparkMaxPWM
    kResourceType_RobotDrive: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_RobotDrive
    kResourceType_SPI: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_SPI
    kResourceType_SRF08: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_SRF08
    kResourceType_ScanseSweep: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_ScanseSweep
    kResourceType_SerialPort: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_SerialPort
    kResourceType_Servo: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Servo
    kResourceType_Shuffleboard: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Shuffleboard
    kResourceType_SmartDashboard: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_SmartDashboard
    kResourceType_Solenoid: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Solenoid
    kResourceType_Talon: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Talon
    kResourceType_TalonFX: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_TalonFX
    kResourceType_Task: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Task
    kResourceType_TrapezoidProfile: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_TrapezoidProfile
    kResourceType_Ultrasonic: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Ultrasonic
    kResourceType_Units: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Units
    kResourceType_UsbCamera: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_UsbCamera
    kResourceType_Victor: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_Victor
    kResourceType_VictorSP: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_VictorSP
    kResourceType_XboxController: hal._wpiHal.tResourceType # value = tResourceType.kResourceType_XboxController
    pass
...
def createSimDevice(name: str) -> int:
    ...
    """
def createSimValue(device: int, name: str, readonly: int, initialValue: HAL_Value) -> int:
    pass
def createSimValueBoolean(device: int, name: str, readonly: int, initialValue: int) -> int:
    """
    ...
    """
def createSimValueDouble(device: int, name: str, readonly: int, initialValue: float) -> int:
    """
    ...
    :returns: simulated value handle
    """
def createSimValueEnum(device: int, name: str, readonly: bool, options: typing.List[str], initialValue: int) -> int:
    """
...
def getCurrentThreadPriority(isRealTime: int) -> typing.Tuple[int, int]:
    ...
    :returns: The current thread priority. Scaled 1-99, with 1 being
              highest.
    """
...
def updateNotifierAlarm(notifierHandle: int, triggerTime: int) -> int:
    ...
    """
def waitForCachedControlData() -> None:
    """
    ...
    """
def waitForCachedControlDataTimeout(timeout: float) -> int:
    """
    Checks if new control data has arrived since the last
    HAL_WaitForCachedControlData or HAL_IsNewControlData call. If new data has
