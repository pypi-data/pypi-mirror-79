...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of lilt.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the lilt.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = lilt.Configuration(
        signing_info = lilt.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://lilt.com/2",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("lilt")
