...
SCHOOL_NAME = os.getenv("SCHOOL_NAME", "test_zz")
...
REST_TABLE_KEY1 = os.getenv("REST_TABLE_KEY1", "A-")
REST_TABLE_KEY2 = os.getenv("REST_TABLE_KEY2", "B-")
...
# redis
REDIS_HOST = os.getenv("REDIS_HOST", "10.88.190.74")
