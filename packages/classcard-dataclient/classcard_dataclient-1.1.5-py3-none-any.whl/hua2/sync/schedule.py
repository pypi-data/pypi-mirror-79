...
from config import SCHOOL_SEASON, REST_TABLE_KEY1, REST_TABLE_KEY2
...
class ScheduleSync(BaseSync):
    ...
    def get_rest_table_map(self, semester_name):
        key1, key2 = REST_TABLE_KEY1, REST_TABLE_KEY2
        rest_table_name1 = "{}作息".format(key1)
        rest_table_name2 = "{}作息".format(key2)
        rest_table1 = RestTableV2(name=rest_table_name1, number=get_md5_hash(rest_table_name1)[:20],
                                  semester_name=semester_name)
        rest_table2 = RestTableV2(name=rest_table_name2, number=get_md5_hash(rest_table_name2)[:20],
                                  semester_name=semester_name)
        rest_table_map = {key1: rest_table1, key2: rest_table2}
        self.rest_table_slot[rest_table_name1] = []
        self.rest_table_slot[rest_table_name2] = []
