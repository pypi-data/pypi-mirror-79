...
def _get_kwargs(
    *,
    ...
    if custom_entity_ids is None:
        json_custom_entity_ids = None
    else:
        json_custom_entity_ids = custom_entity_ids

    params: Dict[str, Any] = {}
    if custom_entity_ids is not None:
        params["customEntityIds"] = json_custom_entity_ids
