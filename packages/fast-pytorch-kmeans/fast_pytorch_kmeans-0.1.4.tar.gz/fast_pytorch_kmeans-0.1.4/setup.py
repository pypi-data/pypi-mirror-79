...
setup(
  ...
  download_url = 'https://github.com/DeMoriarty/fast_pytorch_kmeans/archive/v_014.tar.gz',    # I explain this later on
  keywords = ['KMeans', 'K-means', 'pytorch','machine learning','product quantization', 'ANN'],   # Keywords that define your package best
