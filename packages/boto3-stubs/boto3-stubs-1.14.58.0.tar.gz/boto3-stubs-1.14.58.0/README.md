...
[boto3 1.14.58](https://boto3.amazonaws.com/v1/documentation/api/1.14.58/index.html)
compatible with
...
- `boto3-stubs[redshift-data]` - Type annotations for [RedshiftData](https://pypi.org/project/mypy-boto3-redshift-data/) service.
