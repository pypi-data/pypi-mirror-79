...
class Manuscript(Endpoint):
    ...
    def export_version(self, identifier: str) -> Dict[str, Any]:
        ...
        :param identifier: Identifier of the manuscript version.
        :return: Parts of the manuscript version with content.
        """
        return self._request(self.path_version_export.format(identifier))['parts']
