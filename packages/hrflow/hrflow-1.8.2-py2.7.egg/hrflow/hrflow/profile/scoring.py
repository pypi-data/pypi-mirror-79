...
class ProfileScoring():
    ...
    def list(self, source_keys=None, board_key=None, job_key=None, use_agent=1, agent_key=None,  stage=None, page=1,
        ...
        query_params = {'source_keys': json.dumps(validate_provider_keys(source_keys)),
                        ...
                        'sort_by': validate_value(sort_by, SORT_BY_VALUES),
                        'order_by': validate_value(order_by, ORDER_BY_VALUES)
                        }
