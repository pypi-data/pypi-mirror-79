...
from .dataset import DataSegmentClient, FusionDataSegmentClient
from .gas import GAS
...
@click.pass_context
def cli(ctx: click.Context, access_key: str, url: str, config_name: str) -> None:
...
def _echo_segment(
    dataset_name: str,
    segment_name: str,
    segment: Union[DataSegmentClient, FusionDataSegmentClient],
    list_all_files: bool,
) -> None:
    """Echo a segment.
    ...
    """
    if isinstance(segment, DataSegmentClient):
