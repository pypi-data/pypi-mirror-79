...
class Localization(object):
    ...
    def __init__(self, attributes=None, created_datetime=None, email=None, frame=None, height=None, id=None, media=None, meta=None, modified_by=None, modified_datetime=None, parent=None, project=None, thumbnail_image=None, u=None, user=None, v=None, version=None, width=None, x=None, y=None, local_vars_configuration=None):  # noqa: E501
