...
class Media(object):
    ...
    def __init__(self, attributes=None, codec=None, created_by=None, created_datetime=None, file=None, fps=None, gid=None, height=None, id=None, last_edit_end=None, last_edit_start=None, md5=None, media_files=None, meta=None, modified_by=None, modified_datetime=None, name=None, num_frames=None, original=None, project=None, segment_info=None, thumbnail=None, thumbnail_gif=None, uid=None, width=None, local_vars_configuration=None):  # noqa: E501
