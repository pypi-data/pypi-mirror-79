...
class Contributor(Model):
    ...
    organisation = models.ForeignKey(Organisation, null=True, on_delete=models.CASCADE, related_name="contributors")
...
class BrokenLink(Model):
    submitter = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="brokenlink_submitter")
