...
VISN20_VISTAS = {"668": "SPO", "663": "PUG", "648": "POR", "687": "WWW", "531": "BOI", "692": "WCO", "653": "ROS"} # export to others
...
def keyStats(values):
    ...
    stats = {"total": sum(val for val in values), "count": len(values), "min": mn, "quartileOne": quartileOne, "median": median, "quartileThree": quartileThree, "max": mx, "iqr": iqr, "oht": oht, "ohto": ohto, "mean": meen, "pstd": pdev, "cvar": cvar}
