...
"""       
    ...
    VISN20s = {"363": "ANC", "531": "BOI", "687": "WWW", "668": "SPO", "648": "POR", "653": "ROS", "663": "PUG", "692": "WCO"}
...
: {DAY}\n                    by: {author-dictator}\n
 ",
    ...
    def enforceOnlyTelerHasARnDoc(st):
        ...
        # weaked as 653 has weird one with this but is cancelled - wierd as travel service sent to remote
        # dermo service
        if "tiu_result_narrative" in st and not re.search(r'CANCELLED', singleValue(st, "cprs_status")):
