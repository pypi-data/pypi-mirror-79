...
def main():
    ...
    dirName = "User"
    cud = CommonUserDirectory(VISN20_VISTAS)
...
""".format(
    ...
    ttlPlotData, ttlMU = makeTotalsSection(cud, VISN20_VISTAS)
    mu += ttlMU
    plotData.update(ttlPlotData)
    
    tsPlotData, tsMU = makeTimeSeriesSection(cud, VISN20_VISTAS)
    mu += tsMU
