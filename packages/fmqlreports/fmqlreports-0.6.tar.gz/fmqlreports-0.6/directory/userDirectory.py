...
from fmqlreports.webReportUtils import reduce200

from fileDirectory import VISN20_VISTAS # TMP - move to webReportUtils
...
def main():
    ...
    print(cud.report())
    json.dump(cud.entryDatesBySNO(), open("Meta/Common/userDatesBySNO.json", "w"), indent=4)
