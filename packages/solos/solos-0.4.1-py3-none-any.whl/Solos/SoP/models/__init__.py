...
class NetWrapper(torch.nn.Module):
    ...
    def forward(self,*args):
        ...
        feat_frames= activate(feat_frames, 'sigmoid')

        # 3. sound synthesizer
        pred_masks = self.net_synthesizer(feat_frames, feat_sound)
        # pred_masks = activate(pred_masks, 'sigmoid')
