...
"""
Credits to Olga Slizovskaia
https://github.com/Veleslavia/vimss_torch_dev/blob/master/datasets/urmp.py
"""
...
class URMP(torch.utils.data.Dataset):
    ...
    def save_predicted(self, output_dir, wav_predicted, item_idx):
        import librosa
        import pathlib
