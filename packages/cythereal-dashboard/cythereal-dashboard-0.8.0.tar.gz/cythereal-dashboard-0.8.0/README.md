...
*InvestigationsApi* | [**delete_investigation**](docs/InvestigationsApi.md#delete_investigation) | **DELETE** /investigations/{investigation_name}/ | Deletes an individual investigation
