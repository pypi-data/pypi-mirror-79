...
class InvestigationsApi(object):
    ...
    def create_investigation(self, investigation_name, binaries, **kwargs):  # noqa: E501
        """Create a new Investigation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_investigation(investigation_name, binaries, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_investigation_with_http_info(investigation_name, binaries, **kwargs)  # noqa: E501
        else:
            (data) = self.create_investigation_with_http_info(investigation_name, binaries, **kwargs)  # noqa: E501
            return data

    def create_investigation_with_http_info(self, investigation_name, binaries, **kwargs):  # noqa: E501
        """Create a new Investigation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_investigation_with_http_info(investigation_name, binaries, async_req=True)
        >>> result = thread.get()
        ...
        if 'binaries' in params:
            header_params['binaries'] = params['binaries']  # noqa: E501
