...
*InvestigationsApi* | [**delete_investigation**](docs/InvestigationsApi.md#delete_investigation) | **POST** /investigations/{investigation_name}/delete/ | Deletes an individual investigation
