...
class InvestigationsApi(object):
    ...
    def delete_investigation(self, investigation_name, **kwargs):  # noqa: E501
        """Deletes an individual investigation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_investigation(investigation_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_investigation_with_http_info(investigation_name, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_investigation_with_http_info(investigation_name, **kwargs)  # noqa: E501
            return data

    def delete_investigation_with_http_info(self, investigation_name, **kwargs):  # noqa: E501
        """Deletes an individual investigation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_investigation_with_http_info(investigation_name, async_req=True)
        >>> result = thread.get()
        ...
        if ('investigation_name' not in params or
                params['investigation_name'] is None):
            raise ValueError("Missing the required parameter `investigation_name` when calling `delete_investigation`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/investigations/{investigation_name}/delete/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
