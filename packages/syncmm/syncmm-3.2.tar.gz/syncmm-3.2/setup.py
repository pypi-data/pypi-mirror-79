...
setup(
  ...
  download_url = 'https://github.com/yepiwt/syncmm/archive/3.2.tar.gz',    # I explain this later on
  keywords = ['Sync', 'Music', 'vk', 'yandex', 'yandex_music', 'my music','musiclibrary'],   # Keywords that define your package best
