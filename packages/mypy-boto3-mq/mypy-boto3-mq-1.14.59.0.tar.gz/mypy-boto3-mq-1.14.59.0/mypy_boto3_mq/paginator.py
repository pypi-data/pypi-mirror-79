...
class ListBrokersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBrokers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.59/reference/services/mq.html#MQ.Paginator.ListBrokers.paginate)
        """
