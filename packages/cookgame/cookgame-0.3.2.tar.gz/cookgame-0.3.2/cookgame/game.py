...
ALL = [
    'apple.png', 'banana.png', 'bone.png', 'cup.png', 'chick.png', 'cola.png',
    'fish.png'
]
...
class Kitchen(arcade.Window):
    ...
    def build(self, l=4, r=2, num=1, bgpic=None):
        ...
        if num > 1 and num <= len(ALL):
            ...
            self.rubbish_textures = [TEXTUREPATH + pic for pic in lst]
        elif num > len(ALL):
            self.rubbish_textures = [TEXTUREPATH + pic for pic in ALL]
        self.has_bomb = False
