...
class QtDataVisualization(Shiboken.Object):
    ...
    class QCustom3DVolume(PySide2.QtDataVisualization.QCustom3DItem):
        ...
        def __init__(self, parent: typing.Optional[PySide2.QtCore.QObject]=...): ...
        @typing.overload
        def __init__(self, position: PySide2.QtGui.QVector3D, scaling: PySide2.QtGui.QVector3D, rotation: PySide2.QtGui.QQuaternion, textureWidth: int, textureHeight: int, textureDepth: int, textureData: typing.List[int], textureFormat: PySide2.QtGui.QImage.Format, colorTable: typing.List[int], parent: typing.Optional[PySide2.QtCore.QObject]=...): ...
        ...
        def setTextureData(self, data: typing.List[int]): ...
