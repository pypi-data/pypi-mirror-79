...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.4.0-alpha.1599842586+53cd4263'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.4.0-alpha.1599842586+53cd4263`
                """)
            else:
                raise
