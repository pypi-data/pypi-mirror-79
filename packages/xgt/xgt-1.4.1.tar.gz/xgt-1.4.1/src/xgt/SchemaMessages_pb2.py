...
_ANYFRAME = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error_frame_name', full_name='xgt.AnyFrame.error_frame_name', index=6,
