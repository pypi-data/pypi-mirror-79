...
class Connection(object):
  ...
  def create_namespace(self, name, security_labels = None, attempts = 1):
    """
  ...
  def create_edge_frame(self, name, schema, source, target, source_key,
                        target_key, security_labels = None, attempts = 1):
    """
  ...
  def run_job(self, query, optlevel=4, description=None, timeout=0,
    ...
    """
    kwargs.update(optlevel=optlevel, description=description,
  ...
  def schedule_job(self, query, optlevel=4, description=None, timeout=0,
                   record_history=True, **kwargs):
    """
