...
import testumap.distances as dist

import testumap.sparse as sparse
import testumap.sparse_nndescent as sparse_nn

from testumap.utils import (
    tau_rand_int,
    deheap_sort,
    submatrix,
    ts,
...
from testumap.rp_tree import rptree_leaf_array, make_forest
from testumap.nndescent import (
    # make_nn_descent,
...
from testumap.rp_tree import rptree_leaf_array, make_forest
from testumap.spectral import spectral_layout
from testumap.utils import deheap_sort, submatrix
from testumap.layouts import (
...
def nearest_neighbors(
    ...
    if metric == "precomputed":
        ...
        if _HAVE_PYNNDESCENT and use_pynndescent:
            ...
            # Otherwise fall back to nn descent in testumap
            if callable(metric):
            ...
            if alpha < 0.99:
                ...
                try:
                    ...
                    if self._sparse_data:
                        # Get a fresh metric since we are casting to dense
                        if not callable(self.metric):
                            _m2 = dist.named_distances[self.metric]
                            dmat2 = dist.pairwise_special_metric(
