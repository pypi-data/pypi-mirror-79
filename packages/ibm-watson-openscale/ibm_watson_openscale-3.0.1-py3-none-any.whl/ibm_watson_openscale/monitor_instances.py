...
from ibm_watson_openscale.base_classes.watson_open_scale_v2 import Runs, Measurements, Metrics,ExplanationTasks
...
class MonitorInstances(BaseInstances):
    ...
    def upload_drift_model(self, model_path: str, data_mart_id: str, subscription_id: str,
        ...
        sdk_headers = get_sdk_headers(service_name=self.watson_open_scale.DEFAULT_SERVICE_NAME, service_version='V2',
                                      operation_id='upload_drift_model')
        ...
        request = self.watson_open_scale.prepare_request(method='POST',
                                                          ...
                                                          params=parameters,
                                                          data=drift_model)
        request['url'] = f"https://{request['url'].split('/')[2]}/openscale/{data_mart_id}{url}"
