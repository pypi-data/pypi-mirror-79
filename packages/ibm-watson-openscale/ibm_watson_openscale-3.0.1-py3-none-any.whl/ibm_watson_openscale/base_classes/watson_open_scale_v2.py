...
# IBM OpenAPI SDK Code Generator Version: 99-SNAPSHOT-f4d6992b-20200902-082203
...
class Subscriptions:
    ...
    def add(self,
        ...
        *,
        ...
        data_sources: 'DataSourceCollection' = None,
        **kwargs
    ) -> DetailedResponse:
        """
        ...
        :param DataSourceCollection data_sources: (optional)
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        ...
        if data_sources is not None:
            data_sources = convert_model(data_sources)
        headers = {}
        sdk_headers = get_sdk_headers(service_name=self.watson_open_scale.DEFAULT_SERVICE_NAME,
                                      service_version='V2',
...
class DataSourceCollection():
    ...
    :attr List[DataSource] data_sources:
    """

    def __init__(self,
                 data_sources: List['DataSource']) -> None:
        """
        Initialize a DataSourceCollection object.

        :param List[DataSource] data_sources:
        """
        self.data_sources = data_sources

    @classmethod
    def from_dict(cls, _dict: Dict) -> 'DataSourceCollection':
        """Initialize a DataSourceCollection object from a json dictionary."""
        args = {}
        if 'data_sources' in _dict:
            args['data_sources'] = [DataSource.from_dict(x) for x in _dict.get('data_sources')]
        else:
            raise ValueError('Required property \'data_sources\' not present in DataSourceCollection JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this DataSourceCollection object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'DataSourceCollection') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'DataSourceCollection') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class DataSourceConnection():
    ...
    :attr str type: (optional) Type of integrated system, e.g. hive.
    :attr str integrated_system_id: (optional) id of the integrated system.
    :attr object parameters: (optional) Additional parameters.
    """
    ...
    def __init__(self,
        ...
        :param str type: (optional) Type of integrated system, e.g. hive.
        :param str integrated_system_id: (optional) id of the integrated system.
        :param object parameters: (optional) Additional parameters.
        """
        self.type = type
...
class SubscriptionResponseEntity():
    ...
    :attr DataSourceCollection data_sources: (optional)
    :attr Status status: (optional)
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'SubscriptionResponseEntity':
        ...
        if 'data_sources' in _dict:
            args['data_sources'] = DataSourceCollection.from_dict(_dict.get('data_sources'))
        if 'status' in _dict:
            args['status'] = Status.from_dict(_dict.get('status'))
        return cls(**args)
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'data_sources') and self.data_sources is not None:
            _dict['data_sources'] = self.data_sources.to_dict()
        if hasattr(self, 'status') and self.status is not None:
            _dict['status'] = self.status.to_dict()
        return _dict
