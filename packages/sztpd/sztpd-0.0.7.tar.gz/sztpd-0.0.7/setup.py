...
setuptools.setup(
    ...
    install_requires=['six', 'sqlalchemy', 'sqlalchemy_utils', 'pysqlite3', 'cryptography', 'yangson', 'aiohttp==3.6.2', 'basicauth', 'pyasn1', 'pyasn1-modules>=0.2.6', 'pem', 'passlib', 'requests', 'certvalidator', 'fifolock'],
