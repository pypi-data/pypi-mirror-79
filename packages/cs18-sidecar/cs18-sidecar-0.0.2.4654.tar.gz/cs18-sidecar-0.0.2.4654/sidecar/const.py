...
def get_hosted_app_label_name(app_name: str):
    return _get_tag_name(f'hosted-app-{app_name}')
...
class Const:
    ...
    CONTROL_ELEMENT = _get_tag_name('control-element')

    K8S_SIDECAR_APP_NAME = 'colony-sidecar'
    ...
    SERVICES_EXECUTOR_ELEMENT_NAME = _get_tag_name('services-executor')
    SERVICES_TERMINATOR_ELEMENT_NAME = _get_tag_name('services-terminator')
