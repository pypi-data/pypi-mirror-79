...
from Utils import Utils, Style
from Functions import Functions
from PrettyTable import PrettyTable
from Config import Config
from Emoticons import Emoticons
from PyEc2Cp import PyEc2CP
from PyElbCp import PyElbCP
from PyS3Cp import PyS3CP
from PyR53Cp import PyR53CP
from pymxgraph.PymxGraph import PymxGraph
from pymxgraph.PymxGraphAwsNavigator import PymxGraphAwsNavigator
...
class PyAwsShell(cmd.Cmd):
    Utils.clearScreen()
    intro =  "\n" + \
             Style.CYAN  + "   Wellcome to " + Style.RESET + "AWS" + Style.CYAN + " C:\> " + Style.RESET + "Shell" + Style.CYAN + " $:~" +  Style.RESET + " Cockpit" + Style.CYAN + " version " + Style.RESET + "v0.5" + Style.RESET + "\n\n" + \
             Style.YELLOW  + \
