...
class TransactionDetail(object):
    ...
    def __init__(self, account_id=None, amount=None, approved=None, category_id=None, cleared=None, date=None, deleted=None, flag_color=None, id=None, import_id=None, matched_transaction_id=None, memo=None, payee_id=None, transfer_account_id=None, transfer_transaction_id=None, account_name=None, category_name=None, payee_name=None, subtransactions=None):  # noqa: E501
