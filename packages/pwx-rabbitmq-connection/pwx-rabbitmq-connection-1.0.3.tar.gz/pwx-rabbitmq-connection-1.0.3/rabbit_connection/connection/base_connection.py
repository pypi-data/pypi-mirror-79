    ...
    def _make_connection(self):
        try:
            ...
            if self.__connection_retries < 3:
                print('Ocorreu um erro ao tentar conectar com o Rabbit. Tentando conectar novamente.', flush=True)
                sleep(5)
                self._make_connection()
            else:
                print('Ocorreu um erro ao tentar conectar com o Rabbit. Desistindo após tentar %d vezes.' %
