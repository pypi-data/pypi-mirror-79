...
class ContentPackagesApi(object):
    ...
    def read5(self, npm_package_href, **kwargs):  # noqa: E501
        """Inspect a package  # noqa: E501

        A ViewSet for Package.  Define endpoint name which will appear in the API endpoint for this content type. For example::     http://pulp.example.com/pulp/api/v3/content/npm/units/  Also specify queryset and serializer for Package.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read5(npm_package_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read5_with_http_info(npm_package_href, **kwargs)  # noqa: E501

    def read5_with_http_info(self, npm_package_href, **kwargs):  # noqa: E501
        """Inspect a package  # noqa: E501

        A ViewSet for Package.  Define endpoint name which will appear in the API endpoint for this content type. For example::     http://pulp.example.com/pulp/api/v3/content/npm/units/  Also specify queryset and serializer for Package.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read5_with_http_info(npm_package_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('npm_package_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `npm_package_href` when calling `read5`")  # noqa: E501
