...
class SnapshotsApiRouter(VersionRouter):
    function_library = {
        "delete_snapshot": {"4.8.4-4.11.1": delete_snapshot},
        "get_download_snapshot": {"4.8.4-4.11.1": get_download_snapshot},
        "get_snapshots": {"4.8.4-4.11.1": get_snapshots},
        "post_create_snapshot": {"4.8.4-4.11.1": post_create_snapshot},
        "put_import_snapshot": {"4.8.4-4.11.1": put_import_snapshot},
    }
