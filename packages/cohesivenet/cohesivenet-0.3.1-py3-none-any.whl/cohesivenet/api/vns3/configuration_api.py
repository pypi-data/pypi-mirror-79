...
class ConfigurationApiRouter(VersionRouter):
    ...
    function_library = {
        "get_config": {"4.8.4-4.11.1": get_config},
        "get_keyset": {"4.8.4-4.11.1": get_keyset},
        "get_ssl_install_status": {"4.8.4-4.11.1": get_ssl_install_status},
        "put_config": {"4.8.4-4.11.1": put_config},
        "put_install_ssl_keypair": {"4.8.4-4.11.1": put_install_ssl_keypair},
        "put_keyset": {"4.8.4-4.11.1": put_keyset},
        "put_update_admin_ui": {"4.8.4-4.11.1": put_update_admin_ui},
        "put_update_api_password": {"4.8.4-4.11.1": put_update_api_password},
        "put_upload_ssl_keypair": {"4.8.4-4.11.1": put_upload_ssl_keypair},
        "post_send_test_ms_alert": {"4.8.4-4.11.1": post_send_test_ms_alert},
        "get_ms_config": {"4.8.4-4.11.1": get_ms_config},
        "post_set_ms_config": {"4.8.4-4.11.1": post_set_ms_config},
        "update_ms_config": {"4.8.4-4.11.1": update_ms_config},
        "try_get_keyset": {"4.8.4-4.11.1": try_get_keyset},
        "wait_for_keyset": {"4.8.4-4.11.1": wait_for_keyset},
    }
