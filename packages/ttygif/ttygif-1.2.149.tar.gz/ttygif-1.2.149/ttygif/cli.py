...
def main():
    ...
    print("  created by: Charles Watkins\n")
    ...
    parser.add_argument('--loop',      help='number of loops to play, 0=unlimited', default=0,metavar='COUNT', type=int)
    parser.add_argument('--delay',     help='delay before restarting gif in milliseconds (400=4 Seconds) ', default=400,metavar='MS', type=int)
    ...
    parser.add_argument('--theme',     help='load custom theme/colors (game,windows7/default)',default='default')
