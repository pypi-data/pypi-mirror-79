...
class Dialog(EasyDialog):
    ...
    sig_start = Signal(str, str, str, float, float)
    ...
    def apply(self):
        ...
        self.sig_start.emit(point_name, object_name, prop_name, vmin, vmax)

    def load_object(self):
        point_name = self.grabob.lineedit.edit.text()
        new_name = point_name + '_pt'
        self.newPoint.edit.setText(new_name)
