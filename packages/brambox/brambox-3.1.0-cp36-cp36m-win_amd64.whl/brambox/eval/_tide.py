...
class TIDE:
    ...
    """
    def __init__(self, detection, annotation, pos_thresh=0.5, bg_thresh=0.1, max_det=100, tqdm=True):
    ...
    def compute(self, map=False, mdap_localisation=False, mdap_classification=False, mdap_both=False, mdap_duplicate=False, mdap_background=False, mdap_missed=False, mdap_fp=False, mdap_fn=False, force=False):
        ...
        # No recomputes
        if not any([map, mdap_localisation, mdap_classification, mdap_both, mdap_duplicate, mdap_background, mdap_missed, mdap_fp, mdap_fn]):
        ...
        # Find Error Types
        if any([mdap_localisation, mdap_classification, mdap_both, mdap_duplicate, mdap_background, mdap_missed]):
        ...
        # Fix Errors
        cl_iter = _tqdm(self.class_label, desc='classes') if self.tqdm else self.class_label
    ...
    def compute_matches(self, det, anno, iou):
        ...
        """
        dm, am = stat.match_box(det, anno, iou, class_label=True)
