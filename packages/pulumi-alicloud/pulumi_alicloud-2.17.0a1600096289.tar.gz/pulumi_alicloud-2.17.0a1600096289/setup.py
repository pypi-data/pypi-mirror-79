...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.17.0-alpha.1600096289+1b5ec750'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.17.0-alpha.1600096289+1b5ec750`
                """)
            else:
                raise
