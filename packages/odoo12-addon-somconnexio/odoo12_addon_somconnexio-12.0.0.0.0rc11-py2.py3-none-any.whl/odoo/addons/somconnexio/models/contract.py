...
class Contract(models.Model):
    ...
    mobile_contract_service_info = fields.Many2one(
        'mobile.service.contract.info',
        string='Service Contract Info'
    )
    vodafone_fiber_service_contract_info = fields.Many2one(
        'vodafone.fiber.service.contract.info',
        string="Service Contract Info"
    )
    orange_fiber_service_contract_info = fields.Many2one(
        'orange.fiber.service.contract.info',
        string='Service Contract Info'
    )
    orange_adsl_service_contract_info = fields.Many2one(
