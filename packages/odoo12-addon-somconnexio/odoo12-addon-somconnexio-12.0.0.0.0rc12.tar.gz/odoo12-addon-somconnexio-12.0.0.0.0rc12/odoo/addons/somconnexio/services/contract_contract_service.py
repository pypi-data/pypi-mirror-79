...
class ContractService:
    ...
    def _create_orange_adsl_contract_service_info(self, params):
        if not params:
            return False
        ...
        return self.env['orange.adsl.service.contract.info'].sudo().create({
            'phone_number': params['phone_number'],
    ...
    def _prepare_create(self, params):
        ...
        orange_adsl_contract_service_info = (
            self._create_orange_adsl_contract_service_info(
                params.get('orange_adsl_contract_service_info')
            )
        )
        ...
        response = {
            ...
            'orange_adsl_service_contract_info_id': (
                orange_adsl_contract_service_info and
                orange_adsl_contract_service_info.id
            ),
    ...
    def _get_router_product_id(self, product_id):
        ...
        if router_product:
            ...
            raise wrapJsonException(
                BadRequest(_('No router product id for %d' % product_id))
            )
