...
@jsii.data_type(
    jsii_type="monocdk-experiment.assets.FingerprintOptions",
...
@jsii.enum(jsii_type="monocdk-experiment.assets.FollowMode")
...
@jsii.interface(jsii_type="monocdk-experiment.assets.IAsset")
...
class _IAssetProxy:
    ...
    __jsii_type__ = "monocdk-experiment.assets.IAsset"
...
class Staging(
    _AssetStaging_5a226461,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.assets.Staging",
):
    """Deprecated.
...
@jsii.data_type(
    jsii_type="monocdk-experiment.assets.StagingProps",
