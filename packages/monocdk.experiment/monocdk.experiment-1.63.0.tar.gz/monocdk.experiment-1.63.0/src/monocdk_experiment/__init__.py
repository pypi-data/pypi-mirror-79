...
class FeatureFlags(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.FeatureFlags"
):
...
class StackSynthesizer(
    metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.StackSynthesizer"
):
...
class CfnHook(
    CfnElement, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.CfnHook"
):
