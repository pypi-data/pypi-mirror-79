...
class DatabaseClusterAttributes:
    def __init__(
        ...
        *,
        ...
        cluster_endpoint_address: typing.Optional[str] = None,
        instance_endpoint_addresses: typing.Optional[typing.List[str]] = None,
        instance_identifiers: typing.Optional[typing.List[str]] = None,
        port: typing.Optional[jsii.Number] = None,
        reader_endpoint_address: typing.Optional[str] = None,
    ...
    @builtins.property
    def cluster_endpoint_address(self) -> typing.Optional[str]:
    ...
    @builtins.property
    def instance_endpoint_addresses(self) -> typing.Optional[typing.List[str]]:
    ...
    @builtins.property
    def instance_identifiers(self) -> typing.Optional[typing.List[str]]:
    ...
    @builtins.property
    def reader_endpoint_address(self) -> typing.Optional[str]:
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_rds.DatabaseClusterFromSnapshotProps",
    jsii_struct_bases=[],
    name_mapping={
        "engine": "engine",
...
class DatabaseInstanceNewProps:
    def __init__(
        ...
        *,
        ...
        deletion_protection: typing.Optional[bool] = None,
        domain: typing.Optional[str] = None,
        domain_role: typing.Optional[_IRole_e69bbae4] = None,
    ...
    @builtins.property
    def domain_role(self) -> typing.Optional[_IRole_e69bbae4]:
        ...
        :stability: experimental
        """
        return self._values.get("domain_role")
...
class _IInstanceEngineProxy(jsii.proxy_for(IEngine)):
    ...
    def bind_to_instance(
        ...
        *,
        ...
        :stability: experimental
        """
        options = InstanceEngineBindOptions(domain=domain, timezone=timezone)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"domain": "domain", "timezone": "timezone"},
)
...
class DatabaseClusterBase(
    ...
    jsii_type="monocdk-experiment.aws_rds.DatabaseClusterBase",
):
...
class _DatabaseClusterBaseProxy(
    DatabaseClusterBase, jsii.proxy_for(_Resource_884d0774)
):
    @builtins.property
    @jsii.member(jsii_name="clusterEndpoint")
    def cluster_endpoint(self) -> "Endpoint":
...
class DatabaseClusterFromSnapshot(
    DatabaseClusterBase,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_rds.DatabaseClusterFromSnapshot",
):
    ...
    @jsii.member(jsii_name="setRemovalPolicy")
    def _set_removal_policy(
        self,
        ...
        :stability: experimental
        """
        return jsii.invoke(self, "setRemovalPolicy", [cluster, removal_policy])
    ...
    def _security_groups(self) -> typing.List[_ISecurityGroup_d72ab8e8]:
        """
        stability
        :stability: experimental
        """
    ...
    def _subnet_group(self) -> "CfnDBSubnetGroup":
        """
        stability
        :stability: experimental
        """
