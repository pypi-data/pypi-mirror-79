...
class PipelineDeployStackAction(
    ...
    jsii_type="monocdk-experiment.app_delivery.PipelineDeployStackAction",
):
    ...
    def __init__(
        ...
        *,
        ...
        capabilities: typing.Optional[typing.List[_CloudFormationCapabilities_979dd343]] = None,
...
@jsii.data_type(
    jsii_type="monocdk-experiment.app_delivery.PipelineDeployStackActionProps",
    jsii_struct_bases=[],
    name_mapping={
