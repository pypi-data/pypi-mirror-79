...
class AddFieldOptions:
    ...
    @builtins.property
    def field_name(self) -> typing.Optional[str]:
...
class AwsIamConfig:
    def __init__(self, *, signing_region: str, signing_service_name: str) -> None:
    ...
    @builtins.property
    def signing_service_name(self) -> str:
...
class Directive(
    ...
    @builtins.classmethod
    def cognito(cls, *groups: str) -> "Directive":
    ...
    @builtins.classmethod
    def subscribe(cls, *mutations: str) -> "Directive":
    ...
    def mutation_fields(self) -> typing.Optional[typing.List[str]]:
...
class EnumTypeOptions:
    def __init__(self, *, definition: typing.List[str]) -> None:
...
class IField(jsii.compat.Protocol):
    ...
    def directives_to_string(
        self, modes: typing.Optional[typing.List["AuthorizationType"]] = None
    ) -> str:
...
class InputType(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.InputType"
):
...
class Schema(
    ...
    def add_mutation(self, field_name: str, field: "ResolvableField") -> "ObjectType":
    ...
    def add_query(self, field_name: str, field: "ResolvableField") -> "ObjectType":
    ...
    def add_subscription(
        self, field_name: str, field: "ResolvableField"
    ) -> "ObjectType":
...
@jsii.implements(IIntermediateType)
class UnionType(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.UnionType"
):
    ...
    def __init__(
        self, name: str, *, definition: typing.List["IIntermediateType"]
    ) -> None:
        """
        :param name: -
...
@jsii.implements(IIntermediateType)
class EnumType(
    metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_appsync.EnumType"
):
    ...
    def __init__(self, name: str, *, definition: typing.List[str]) -> None:
        """
        :param name: -
        :param definition: the attributes of this type.
...
class GraphqlType(
    ...
    @jsii.member(jsii_name="directivesToString")
    def directives_to_string(
        self, _modes: typing.Optional[typing.List["AuthorizationType"]] = None
    ) -> str:
        """Generate the directives for this field.
