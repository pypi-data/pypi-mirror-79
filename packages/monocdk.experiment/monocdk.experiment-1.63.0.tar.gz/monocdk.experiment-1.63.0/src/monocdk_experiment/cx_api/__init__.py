...
class CloudArtifact(
    ...
    def __init__(
        ...
        *,
        ...
        metadata: typing.Optional[typing.Mapping[str, typing.List[_MetadataEntry_1c069657]]] = None,
...
class MetadataEntry(_MetadataEntry_1c069657):
    def __init__(
        ...
        *,
        type: str,
        data: typing.Optional[typing.Union[str, _FileAssetMetadataEntry_401d6b3e, _ContainerImageAssetMetadataEntry_d177c3e3, typing.List[_Tag_9bdb11cc]]] = None,
    ...
    def data(
        self,
    ) -> typing.Optional[typing.Union[str, _FileAssetMetadataEntry_401d6b3e, _ContainerImageAssetMetadataEntry_d177c3e3, typing.List[_Tag_9bdb11cc]]]:
        """The data.
