...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_autoscaling_common.Alarms",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_autoscaling_common.ArbitraryIntervals",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_autoscaling_common.CompleteScalingInterval",
    jsii_struct_bases=[],
...
@jsii.interface(jsii_type="monocdk-experiment.aws_autoscaling_common.IRandomGenerator")
...
class _IRandomGeneratorProxy:
    ...
    __jsii_type__ = "monocdk-experiment.aws_autoscaling_common.IRandomGenerator"
...
@jsii.data_type(
    jsii_type="monocdk-experiment.aws_autoscaling_common.ScalingInterval",
    jsii_struct_bases=[],
