...
class CfnStream(
    ...
    def __init__(
        ...
        *,
        ...
        kinesis_configuration: typing.Union["KinesisConfigurationProperty", _IResolvable_9ceae33e],
        ledger_name: str,
        role_arn: str,
        stream_name: str,
    ...
    def kinesis_configuration(
        self,
        value: typing.Union["KinesisConfigurationProperty", _IResolvable_9ceae33e],
    ) -> None:
    ...
    class KinesisConfigurationProperty:
        def __init__(
            self,
            *,
            aggregation_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]] = None,
...
class CfnStreamProps:
    def __init__(
        ...
        *,
        inclusive_start_time: str,
        kinesis_configuration: typing.Union["CfnStream.KinesisConfigurationProperty", _IResolvable_9ceae33e],
        ledger_name: str,
        role_arn: str,
        stream_name: str,
        exclusive_end_time: typing.Optional[str] = None,
