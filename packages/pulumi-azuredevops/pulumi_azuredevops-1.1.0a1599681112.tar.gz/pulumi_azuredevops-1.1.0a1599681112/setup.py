...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '1.1.0-alpha.1599681112+ba2bab71'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 1.1.0-alpha.1599681112+ba2bab71`
                """)
            else:
                raise
