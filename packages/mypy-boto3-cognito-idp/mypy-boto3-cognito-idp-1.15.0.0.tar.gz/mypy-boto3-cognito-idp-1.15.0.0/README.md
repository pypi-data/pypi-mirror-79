...
[boto3.CognitoIdentityProvider 1.15.0](https://boto3.amazonaws.com/v1/documentation/api/1.15.0/reference/services/cognito-idp.html#CognitoIdentityProvider) service
compatible with
