...
The sources for db_faker can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/PBarri/db_faker
.. _tarball: https://github.com/PBarri/db_faker/tarball/master
