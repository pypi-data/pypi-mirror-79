...
class SearchHistory():
    ...
    def load_runs(self):
        ...
        if not self.args.no_download:
            self.init_xtstore()
            self.xtstore.download_file_from_job(self.ws_name, self.args.job, runs_file_name, all_runs_file_path)
    ...
    def evaluate(self):
        ...
        builder = ReportBuilder(self.xt_config, self.xtstore, client=None)
