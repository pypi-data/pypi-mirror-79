...
class Logger:
    ...
    def add_log_level(self, level: str, value: int):
        ...
        :param value: Level of the log (i.e. 35).
        Used to determine if it is included
        """
    ...
    def debug(self, message: str):
        """
        Alias for `logger.log("DEBUG", message)`
        """
        self.log("DEBUG", message)

    def info(self, message: str):
        """
        Alias for `logger.log("INFO", message)`
        """
        self.log("INFO", message)

    def warning(self, message: str):
        """
        Alias for `logger.log("WARNING", message)`
        """
        self.log("WARNING", message)

    def error(self, message: str):
        """
        Alias for `logger.log("ERROR", message)`
        """
        self.log("ERROR", message)

    def critical(self, message: str):
        """
        Alias for `logger.log("CRITICAL", message)`
        """
        self.log("CRITICAL", message)

    def add_webhook(self, webhook: webhooks.Webhook):
        """
