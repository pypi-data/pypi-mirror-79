...
class ApiObject(
    constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk8s.ApiObject"
):
    """
    stability
...
class ApiObjectMetadataDefinition(
    metaclass=jsii.JSIIMeta, jsii_type="cdk8s.ApiObjectMetadataDefinition"
):
    """Object metadata.
    ...
    def get_label(self, key: str) -> typing.Optional[str]:
        """
        :param key: the label.
