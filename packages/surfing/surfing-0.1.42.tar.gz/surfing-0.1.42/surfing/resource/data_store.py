...
class DataStore:
    ...
    @staticmethod
    def refresh_dm(score_pre_calc=True,start_time='20050101',print_time=False,use_weekly_monthly_indicators=False,is_normal_type=False,is_mix_type=False):
        ...
        dm.init(score_pre_calc=score_pre_calc, print_time=print_time, use_weekly_monthly_indicators=use_weekly_monthly_indicators,is_normal_type=is_normal_type,is_mix_type=is_mix_type)
