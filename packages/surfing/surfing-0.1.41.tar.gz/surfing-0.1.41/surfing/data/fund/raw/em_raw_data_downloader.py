    ...
    def em_fund_status(self, end_date: str):
        try:
            ...
            if data1 is None:
                ...
                return False
            data2 = self._em_css_wrapper(fund_list, 'PURCHSTATUS,REDEMSTATUS,LPLIMIT,OTCLPLIMIT,TRADESTATUS', f'TradeDate={end_date},Ispandas=1')
            if data2 is None:
    ...
    def em_index_val(self, start_date: str, end_date: str):
        try:
            ...
            for date in trade_day_df.TRADEDATES:
                ...
                _y = pd.to_datetime(date).date().year + 1
                another_data = self._em_css_wrapper(index_list, "DIVIDENDRATETTM,ESTPEG", f"TradeDate={date},PREDICTYEAR={_y},Ispandas=1")
...
if __name__ == '__main__':
    ...
    em.em_fund_benchmark_history('20150101', '20151231')
