...
class ReportHelper:
    ...
    def asset_price_ratio(self):    
        ...
        return HybridPainter.plot_asset_price_ratio(self.fund_nav, self.fund_info, self.index_price, self.fund_score_dm, self.get_fund_stat(), self.dts, self.saa_weight, fund_trade)
