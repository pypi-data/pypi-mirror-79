...
class StreamingChainObserver:
    ...
    def close_all_streaming_chains(self):
        for listener in list(self._all_chains_listeners.values()):
    ...
    def __dump_chain_listener_info(self, streaming_chain=None):
        if False:
            ...
            for name, item in list(self._all_chains_listeners.items()):
                print(f"\t{name} - {item}")
            print("Streaming Chains :")
            for name, item in list(self._all_streaming_chains.items()):
                print(f"\t{name} - {item}")
            print("##########################################")
