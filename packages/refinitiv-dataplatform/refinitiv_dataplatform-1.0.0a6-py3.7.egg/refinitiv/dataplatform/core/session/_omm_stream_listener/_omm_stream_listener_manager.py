...
class OMMStreamObserver:
    ...
    def close_all_omm_streams(self):
        for listener in list(self._all_omm_stream_listeners.values()):
    ...
    def _check_omm_item_stream(self, omm_item_stream):
        if omm_item_stream is None:
            ...
            return omm_item_stream in list(self._all_omm_item_stream.values())
        else:
    ...
    def __dump_omm_stream_listener_info(self, omm_stream=None):
        if False:
            ...
            print("OMM Streams :")
            for i, item in list(self._all_omm_item_stream.items()):
                print(f"\t{i} - {item.name} - {item.stream_id}")
            print("OMM stream listeners :")
            for i, item in list(self._all_omm_stream_listeners.items()):
