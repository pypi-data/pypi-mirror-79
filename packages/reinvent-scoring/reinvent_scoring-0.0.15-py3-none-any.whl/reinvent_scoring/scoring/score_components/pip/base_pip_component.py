...
class BasePiPComponent(BaseScoreComponent):
    ...
    def _create_url(self, component_name) -> str:
        pip_url = self._get_enviornment_variable("PIP_URL")
        request_url = pip_url.format(component_name)
        return request_url

    def _create_header(self) -> dict:
        pip_key = self._get_enviornment_variable("PIP_KEY")
        header = {"X-API-Key": pip_key}
        return header
    ...
    def _retrieve_pip_url_from_config(self, variable: str) -> str:
        try:
    ...
    def _get_enviornment_variable(self, variable: str) -> str:
        try:
            ...
            return self._retrieve_pip_url_from_config(variable)
