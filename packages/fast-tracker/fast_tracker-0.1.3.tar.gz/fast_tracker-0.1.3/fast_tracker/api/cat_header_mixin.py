from fast_tracker.common.encoding_utils import (obfuscate, deobfuscate,
                                                json_encode, json_decode, base64_encode, base64_decode)


class CatHeaderMixin(object):
    cat_id_key = 'X-fast-ID'
    cat_transaction_key = 'X-fast-Transaction'
    cat_appdata_key = 'X-fast-App-Data'
    cat_synthetics_key = 'X-fast-Synthetics'
    cat_metadata_key = 'x-fast-trace'
    cat_distributed_trace_key = 'fast'
    settings = None
