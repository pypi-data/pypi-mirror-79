...
class TestCognitoConstruct(TestCase):
    ...
    def test_construct_with_default_values(self):
        ...
        self.assertIn(
            ...
            '"EmailVerificationSubject": "Verify your new account", "EnabledMfas": ["SOFTWARE_TOKEN_MFA"], '
            '"MfaConfiguration": "OPTIONAL", "SmsVerificationMessage": "The verification code to your new account is '
        ...
        self.assertIn(
            ...
            '"ExplicitAuthFlows": ["ALLOW_REFRESH_TOKEN_AUTH"], "GenerateSecret": true, "PreventUserExistenceErrors": '
