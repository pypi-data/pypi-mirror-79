...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        MainClientWindow.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        MainClientWindow.setAutoFillBackground(False)
        MainClientWindow.setStyleSheet("font: 10pt \"MS Shell Dlg 2\";\n"
"background-color: rgb(222, 255, 225);")
        self.centralwidget = QtWidgets.QWidget(MainClientWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label_contacts = QtWidgets.QLabel(self.centralwidget)
        self.label_contacts.setGeometry(QtCore.QRect(70, 10, 111, 21))
        self.label_contacts.setStyleSheet("background-color: rgb(255, 255, 127);")
        ...
        self.btn_add_contact.setStyleSheet("background-color: rgb(116, 255, 160);")
        ...
        self.btn_remove_contact.setStyleSheet("background-color: rgb(255, 98, 127)")
        self.btn_remove_contact.setObjectName("btn_remove_contact")
        self.label_history = QtWidgets.QLabel(self.centralwidget)
        self.label_history.setGeometry(QtCore.QRect(450, 0, 141, 21))
        self.label_history.setStyleSheet("background-color: rgb(255, 255, 127);")
        ...
        self.text_message.setGeometry(QtCore.QRect(300, 360, 441, 81))
        self.text_message.setObjectName("text_message")
        self.label_new_message = QtWidgets.QLabel(self.centralwidget)
        self.label_new_message.setGeometry(QtCore.QRect(300, 320, 431, 20))
        self.label_new_message.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.label_new_message.setAutoFillBackground(False)
        self.label_new_message.setStyleSheet("background-color: rgb(255, 255, 127);")
        self.label_new_message.setFrameShadow(QtWidgets.QFrame.Plain)
        self.label_new_message.setAlignment(QtCore.Qt.AlignCenter)
        self.label_new_message.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        self.label_new_message.setObjectName("label_new_message")
        self.list_contacts = QtWidgets.QListView(self.centralwidget)
        self.list_contacts.setGeometry(QtCore.QRect(10, 50, 251, 381))
        self.list_contacts.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.list_contacts.setObjectName("list_contacts")
        self.list_messages = QtWidgets.QListView(self.centralwidget)
        self.list_messages.setGeometry(QtCore.QRect(300, 30, 441, 271))
        self.list_messages.setObjectName("list_messages")
        self.btn_send = QtWidgets.QPushButton(self.centralwidget)
        self.btn_send.setEnabled(True)
        self.btn_send.setGeometry(QtCore.QRect(540, 450, 141, 31))
        font = QtGui.QFont()
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.btn_send.setFont(font)
        self.btn_send.setStyleSheet("background-color: rgb(115, 255, 0);")
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(360, 450, 131, 31))
        self.btn_clear.setStyleSheet("background-color: rgb(124, 159, 255);")
