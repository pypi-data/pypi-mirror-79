...
sys.path.append('../')
from clients.client_windows import Ui_MainClientWindow
...
class ClientMainWindow(QMainWindow):
    ...
    def set_disabled_input(self):
        ...
        self.ui.label_new_message.setText(
            'Выберете контакт из предложеных двойным кликом')
        ...
        try:
            ...
            if err.errno:
                self.messages.critical(
                    self, 'Error', 'Connection with server lost')
                self.close()
            self.messages.critical(
            ...
            self.messages.information(
                self, 'Выполнено', 'Контакт добавлен.')
    ...
    def delete_contact(self, item):
        ...
        try:
            ...
            self.messages.information(self, 'Выполнено', 'Контакт удален.')
            item.close()
    ...
    def connection_lost(self):
        ...
        """
        self.messages.warning(
            self, 'Обрыв соединиения', 'Соединение потеряно. ')
        self.close()
