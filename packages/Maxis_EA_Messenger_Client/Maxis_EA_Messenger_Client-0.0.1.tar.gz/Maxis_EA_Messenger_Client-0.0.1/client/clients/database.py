...
class ClientDatabase:
    ...
    def __init__(self, name):
        ...
        sos = sessionmaker(bind=self.database_engine)
        self.session = sos()
...
if __name__ == '__main__':
    ...
    # test_db.save_message('test2', 'in', f'
    # Привет! я тестовое сообщение от {datetime.datetime.now()}!')
    # test_db.save_message('test2', 'out', f'
    # Привет! я другое тестовое сообщение от {datetime.datetime.now()}!')
