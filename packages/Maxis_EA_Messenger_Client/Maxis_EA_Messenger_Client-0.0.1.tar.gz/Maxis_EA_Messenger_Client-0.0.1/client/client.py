...
from clients.main_windows import ClientMainWindow
...
if __name__ == '__main__':
    ...
    # Создаём GUI
    main_windows = ClientMainWindow(database, transport, keys)
    main_windows.make_connection(transport)
    main_windows.setWindowTitle(f'Чат Программа - {client_name}')
    client_app.exec_()
