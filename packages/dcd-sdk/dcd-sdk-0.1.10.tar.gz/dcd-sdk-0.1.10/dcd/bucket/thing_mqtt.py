    ...
    def init(self):
        ...
        if (MQTT_SECURED):
            ...
            self.mqtt_client.tls_set(
                DIGI_CERT_CA, cert_reqs=ssl.CERT_NONE,
...
def check_digi_cert_ca():
    try:
        f = open(DIGI_CERT_CA)
        logging.debug(DIGI_CERT_CA + " exist.")
        f.close()
    except IOError:
        logging.debug(DIGI_CERT_CA + " missing, downloading...")
        ...
        if response.status_code == 200:
            ...
            # local_file_path
            with open(DIGI_CERT_CA, "wb") as local_file:
