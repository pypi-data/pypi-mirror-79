...
from inference.inference import MtModelInference_Deliverable
...
class MtModelEvaluation_Deliverable(MtModelInference_Deliverable):
    ...
    def _evaluation(self, corpus_test):
        ...
        #model = load(r'D:\Code\python_code\mt_model_code\mtnlp_model\mtnlpmodel\server\evaluation\model')
