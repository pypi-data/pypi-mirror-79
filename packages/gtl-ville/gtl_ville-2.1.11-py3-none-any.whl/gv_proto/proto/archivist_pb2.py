...
_TRAVELTIMESREQUEST = _descriptor.Descriptor(
  name='TravelTimesRequest',
  full_name='gv_proto.proto.TravelTimesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='fromPoint', full_name='gv_proto.proto.TravelTimesRequest.fromPoint', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='toPoint', full_name='gv_proto.proto.TravelTimesRequest.toPoint', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fromdate', full_name='gv_proto.proto.TravelTimesRequest.fromdate', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='todate', full_name='gv_proto.proto.TravelTimesRequest.todate', index=3,
...
_TRAVELTIMES = _descriptor.Descriptor(
  name='TravelTimes',
  full_name='gv_proto.proto.TravelTimes',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='traveltimes', full_name='gv_proto.proto.TravelTimes.traveltimes', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRAVELTIMESREQUEST.fields_by_name['fromdate'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_TRAVELTIMESREQUEST.fields_by_name['todate'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
DESCRIPTOR.message_types_by_name['TravelTimesRequest'] = _TRAVELTIMESREQUEST
...
TravelTimesRequest = _reflection.GeneratedProtocolMessageType('TravelTimesRequest', (_message.Message,), {
  'DESCRIPTOR' : _TRAVELTIMESREQUEST,
  '__module__' : 'gv_proto.proto.archivist_pb2'
  # @@protoc_insertion_point(class_scope:gv_proto.proto.TravelTimesRequest)
  })
_sym_db.RegisterMessage(TravelTimesRequest)

TravelTimes = _reflection.GeneratedProtocolMessageType('TravelTimes', (_message.Message,), {
  'DESCRIPTOR' : _TRAVELTIMES,
  '__module__' : 'gv_proto.proto.archivist_pb2'
  # @@protoc_insertion_point(class_scope:gv_proto.proto.TravelTimes)
  })
