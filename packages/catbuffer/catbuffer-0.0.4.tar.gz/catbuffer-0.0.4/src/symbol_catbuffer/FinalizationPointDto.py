...
class FinalizationPointDto:
    ...
    def __init__(self, finalizationPoint: int):
        """Constructor.
    ...
    def loadFromBinary(cls, payload: bytes) -> FinalizationPointDto:
        ...
        finalizationPoint = GeneratorUtils.bufferToUint(GeneratorUtils.getBytes(bytes_, 8))
    ...
    def serialize(self) -> bytes:
        ...
        """
        bytes_ = bytes()
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, GeneratorUtils.uintToBuffer(self.getFinalizationPoint(), 8))
        return bytes_
