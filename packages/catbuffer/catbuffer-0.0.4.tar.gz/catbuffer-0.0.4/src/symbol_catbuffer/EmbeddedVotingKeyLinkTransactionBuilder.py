...
class EmbeddedVotingKeyLinkTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def __init__(self, size: int, signerPublicKey: KeyDto, version: int, network: NetworkTypeDto, type: EntityTypeDto, linkedPublicKey: VotingKeyDto, startPoint: FinalizationPointDto, endPoint: FinalizationPointDto, linkAction: LinkActionDto):
        """Constructor.
        Args:
            size: Entity size.
        ...
        self.votingKeyLinkTransactionBody = VotingKeyLinkTransactionBodyBuilder(linkedPublicKey, startPoint, endPoint, linkAction)
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedVotingKeyLinkTransactionBuilder:
        ...
        return EmbeddedVotingKeyLinkTransactionBuilder(superObject.size, superObject.signerPublicKey, superObject.version, superObject.network, superObject.type, votingKeyLinkTransactionBody.linkedPublicKey, votingKeyLinkTransactionBody.startPoint, votingKeyLinkTransactionBody.endPoint, votingKeyLinkTransactionBody.linkAction)
    ...
    def getStartPoint(self) -> FinalizationPointDto:
        ...
        """
        return self.votingKeyLinkTransactionBody.getStartPoint()
    ...
    def getEndPoint(self) -> FinalizationPointDto:
        ...
        """
        return self.votingKeyLinkTransactionBody.getEndPoint()
