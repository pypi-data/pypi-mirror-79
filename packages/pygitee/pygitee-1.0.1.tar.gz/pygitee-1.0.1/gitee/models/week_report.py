...
class WeekReport(object):
    ...
    def __init__(self, id=None, content=None, content_html=None, year=None, month=None, week_index=None,
                 week_begin=None, week_end=None, created_at=None, updated_at=None, user=None):  # noqa: E501
