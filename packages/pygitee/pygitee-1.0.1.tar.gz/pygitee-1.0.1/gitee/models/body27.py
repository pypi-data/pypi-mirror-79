...
class Body27(object):
    ...
    def __init__(self, access_token=None, merge_method='merge', prune_source_branch=None, title=None,
    ...
    def access_token(self):
        """Gets the access_token of this Body27.  # noqa: E501

        用户授权码  # noqa: E501

        :return: The access_token of this Body27.  # noqa: E501
        :rtype: str
        """
    ...
    def access_token(self, access_token):
        """Sets the access_token of this Body27.

        用户授权码  # noqa: E501

        :param access_token: The access_token of this Body27.  # noqa: E501
        :type: str
        """
    ...
    def merge_method(self):
        """Gets the merge_method of this Body27.  # noqa: E501

        可选。合并PR的方法，merge（合并所有提交）和 squash（扁平化分支合并）。默认为merge。  # noqa: E501

        :return: The merge_method of this Body27.  # noqa: E501
        :rtype: str
        """
    ...
    def merge_method(self, merge_method):
        """Sets the merge_method of this Body27.

        可选。合并PR的方法，merge（合并所有提交）和 squash（扁平化分支合并）。默认为merge。  # noqa: E501

        :param merge_method: The merge_method of this Body27.  # noqa: E501
        :type: str
        """
    ...
    def prune_source_branch(self):
        """Gets the prune_source_branch of this Body27.  # noqa: E501

        可选。合并PR后是否删除源分支，默认false（不删除）  # noqa: E501

        :return: The prune_source_branch of this Body27.  # noqa: E501
        :rtype: bool
        """
    ...
    def prune_source_branch(self, prune_source_branch):
        """Sets the prune_source_branch of this Body27.

        可选。合并PR后是否删除源分支，默认false（不删除）  # noqa: E501

        :param prune_source_branch: The prune_source_branch of this Body27.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def title(self):
        """Gets the title of this Body27.  # noqa: E501

        可选。合并标题，默认为PR的标题  # noqa: E501

        :return: The title of this Body27.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this Body27.

        可选。合并标题，默认为PR的标题  # noqa: E501

        :param title: The title of this Body27.  # noqa: E501
        :type: str
        """
