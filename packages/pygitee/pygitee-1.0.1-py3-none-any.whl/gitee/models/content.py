...
class Content(object):
    ...
    def __init__(self, type=None, encoding=None, size=None, name=None, path=None, content=None, sha=None, url=None,
                 html_url=None, download_url=None, links=None):  # noqa: E501
