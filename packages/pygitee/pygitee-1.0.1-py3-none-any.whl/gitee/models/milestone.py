...
class Milestone(object):
    ...
    def __init__(self, url=None, html_url=None, number=None, repository_id=None, state=None, title=None,
                 description=None, updated_at=None, created_at=None, open_issues=None, closed_issues=None,
                 due_on=None):  # noqa: E501
