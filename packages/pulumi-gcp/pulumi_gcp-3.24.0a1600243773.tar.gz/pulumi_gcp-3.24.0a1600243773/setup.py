...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.24.0-alpha.1600243773+4fe69dda'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.24.0-alpha.1600243773+4fe69dda`
                """)
            else:
                raise
