...
class Gluetool(object):
    ...
    def _exit_logger(self):
        # type: () -> gluetool.log.ContextAdapter
        ...
        common_logger = gluetool.log.Logging.get_logger()
        ...
        exit_logger.warning('Cannot use custom logger, falling back to a default one')

        return gluetool.log.ContextAdapter(exit_logger)
