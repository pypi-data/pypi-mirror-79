...
def future_editor(colour="black",colour2="white"):
	...
	def change_colour(colour,colour2):
		bg = colour
		fg = colour2
		window.destroy()
		future_editor(colour,colour2)
	def run_code():
	...
	def theme_():
		...
		apply_button = Button(window_theme,bg="white",fg="black",font=font,command = lambda: change_colour(str(text_colour.get()),str(text_colour_1.get())),text="Apply")
		...
		show_colours.grid(row=4,column=1)
