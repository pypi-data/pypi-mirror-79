...
from raft.vendor.six import StringIO

from raft.vendor.six import text_type, binary_type, PY2
from raft.vendor.lexicon import Lexicon
...
def _converge(c):
    ...
    :param c: raft ``Context`` object or subclass.
...
def upload(c, directory, index=None, sign=False, dry_run=False):
    ...
    :param str index:
        ...
        By default, uses whatever the raftd ``pip`` is configured to use.
