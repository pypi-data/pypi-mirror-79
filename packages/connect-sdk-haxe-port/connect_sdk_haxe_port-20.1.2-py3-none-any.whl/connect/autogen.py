...
class connect_logger_Logger(connect_Base):
    ...
    __slots__ = ("path", "level", "handlers", "sections", "maskedFields", "regexMaskingList", "compact", "beautify", "defaultFilename")
    _hx_fields = ["path", "level", "handlers", "sections", "maskedFields", "regexMaskingList", "compact", "beautify", "defaultFilename"]
    _hx_methods = ["getPath", "getLevel", "isBeautified", "isCompact", "setFilename", "getFilename", "getHandlers", "openSection", "closeSection", "writeBlock", "writeCodeBlock", "writeList", "writeTable", "write", "getMaskedFields", "getRegExMaskingList", "log", "debug", "info", "notice", "warning", "error", "critical", "alert", "emergency", "_writeToHandler", "writeSections"]
...
class connect_logger_LoggerConfig(connect_Base):
    ...
    __slots__ = ("path_", "level_", "handlers_", "maskedFields_", "compact_", "beautify_", "regexMaskingList_", "customHandlers")
    _hx_fields = ["path_", "level_", "handlers_", "maskedFields_", "compact_", "beautify_", "regexMaskingList_", "customHandlers"]
    _hx_methods = ["path", "level", "levelName", "handlers", "maskedFields", "beautify", "compact", "regexMasks", "markdown"]
...
class connect_models_AssetRequest(connect_models_IdModel):
    ...
    def addValueToParams(self,obj):
        ...
        if (params is not None):
            def _hx_local_0(p):
                if ((not python_Boot.hasField(p,"value")) and (((not python_Boot.hasField(p,"value_error")) or ((Reflect.field(p,"value_error") == ""))))):
...
class connect_util_Util:
    ...
    def beautifyObject(obj,compact,masked,beautify):
        ...
        if compact:
            ...
            return haxe_format_JsonPrinter.print((connect_util_Util.maskFields(obj) if masked else obj),None,spacing)
