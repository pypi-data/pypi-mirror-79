...
class CfnServer(
    ...
    def __init__(
        ...
        *,
        ...
        endpoint_details: typing.Optional[typing.Union["EndpointDetailsProperty", aws_cdk.core.IResolvable]] = None,
        endpoint_type: typing.Optional[str] = None,
        identity_provider_details: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "IdentityProviderDetailsProperty"]] = None,
    ...
    def endpoint_details(
        self,
    ) -> typing.Optional[typing.Union["EndpointDetailsProperty", aws_cdk.core.IResolvable]]:
    ...
    def endpoint_details(
        self,
        value: typing.Optional[typing.Union["EndpointDetailsProperty", aws_cdk.core.IResolvable]],
    ) -> None:
    ...
    def identity_provider_details(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "IdentityProviderDetailsProperty"]]:
    ...
    def identity_provider_details(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "IdentityProviderDetailsProperty"]],
    ) -> None:
...
class CfnUser(
    ...
    def __init__(
        ...
        *,
        ...
        home_directory_mappings: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "HomeDirectoryMapEntryProperty"]]]] = None,
    ...
    def home_directory_mappings(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "HomeDirectoryMapEntryProperty"]]]]:
    ...
    def home_directory_mappings(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "HomeDirectoryMapEntryProperty"]]]],
    ) -> None:
