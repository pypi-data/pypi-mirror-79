...
class Tracker:
    ...
    @contract
    def __init__(self, emitters, api_key=None, datacoral_env=None, subject=None,
        ...
        self.x_datacoral_environment = datacoral_env
    ...
    def complete_payload(self, pb, context, tstamp):
        ...
        pb.add("x_api_key", self.x_api_key)
        pb.add("x_datacoral_environment", self.x_datacoral_environment)
