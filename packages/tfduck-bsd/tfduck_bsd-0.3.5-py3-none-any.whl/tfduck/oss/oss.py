...
class AliyunOss(object):
    ...
    def download_oss(self, ctx, local_file_path, oss_file_path, max_workers=200, isrm=False):
        """
    ...
    def upload_oss(self, ctx, local_file_path, oss_file_path, add_success=False, add_empty=False, max_workers=200, isrm=False):
        """
