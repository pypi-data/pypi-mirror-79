...
[boto3.ManagedBlockchain 1.14.62](https://boto3.amazonaws.com/v1/documentation/api/1.14.62/reference/services/managedblockchain.html#ManagedBlockchain) service
compatible with
