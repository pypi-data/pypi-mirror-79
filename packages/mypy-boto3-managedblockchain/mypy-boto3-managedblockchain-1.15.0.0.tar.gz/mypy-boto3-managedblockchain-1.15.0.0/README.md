...
[boto3.ManagedBlockchain 1.15.0](https://boto3.amazonaws.com/v1/documentation/api/1.15.0/reference/services/managedblockchain.html#ManagedBlockchain) service
compatible with
