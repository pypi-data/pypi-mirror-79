...
class EmailSubscription(
    ...
    def __init__(
        ...
        *,
        ...
        filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]] = None,
    ) -> None:
        """
        :param email_address: -
    ...
    def bind(
        self, _topic: aws_cdk.aws_sns.ITopic
...
class LambdaSubscription(
    ...
    @jsii.member(jsii_name="bind")
    def bind(
        self, topic: aws_cdk.aws_sns.ITopic
    ) -> aws_cdk.aws_sns.TopicSubscriptionConfig:
...
class SmsSubscription(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.SmsSubscription"
):
...
class SqsSubscription(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.SqsSubscription"
):
...
class SubscriptionProps:
    ...
    def filter_policy(
        self,
    ) -> typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]:
        """The filter policy.
...
class UrlSubscription(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns-subscriptions.UrlSubscription"
):
