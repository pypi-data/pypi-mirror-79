...
class databasesController(GracieBaseAPI):
    ...
    def updateLanguage(self, **kwargs):
        ...
        Args:
            Corpus file name (without folder path). File has to be in [data_sources/knowledge/corpus] directory: (string): Corpus file name (without folder path). File has to be in [data_sources/knowledge/corpus] directory
            languageId: (string): languageId
        ...
        all_api_parameters = {'Corpus file name (without folder path). File has to be in [data_sources/knowledge/corpus] directory': {'name': 'Corpus file name (without folder path). File has to be in [data_sources/knowledge/corpus] directory', 'required': False, 'in': 'query'}, 'languageId': {'name': 'languageId', 'required': False, 'in': 'query'}, 'updateDoc2vec': {'name': 'updateDoc2vec', 'required': False, 'in': 'query'}, 'updateIdfModel': {'name': 'updateIdfModel', 'required': False, 'in': 'query'}}
        parameters_names_map = {}
