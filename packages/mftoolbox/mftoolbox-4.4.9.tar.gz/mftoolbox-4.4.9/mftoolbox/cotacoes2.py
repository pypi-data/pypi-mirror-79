...
def ultimo_preco(ativo='', **kwargs):
    ...
    __url = 'https://www.tradingview.com/symbols/' + ativo
    __browser.get(__url)
    ...
    return [ativo, __nome_pregao, __cotacao, __horario, __variacao_monetaria, __variacao_percentual]
...
def volatilidade(ativo='', **kwargs):
    '''
    Busca no site de B3 a volatilidade de um ativo
    args:
        ativo: ticker do ativo
    **kwargs:
...
'''
    ...
    __url_root = 'http://bvmf.bmfbovespa.com.br/cias-listadas/volatilidade-ativos/' \
               'ResumoVolatilidadeAtivos.aspx?metodo=padrao&periodo=xxxxxxxxxx&codigo=' + ativo + '&idioma=pt-br'
