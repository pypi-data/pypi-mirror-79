...
class ListContainersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListContainers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.15.1/reference/services/mediastore.html#MediaStore.Paginator.ListContainers.paginate)
        """
