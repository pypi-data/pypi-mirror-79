...
class PartyBot(commands.Bot):
    ...
    async def event_friend_add(friend: fortnitepy.Friend):
        try:
    ...
    async def event_friend_remove(friend: fortnitepy.Friend):
        try:
    ...
    async def event_party_member_leave(friend: fortnitepy.Friend):
