...
from vodajemokra.party import ClientParty
...
class HelpCommand:
    ...
    def get_destination(self) -> Union[Friend, ClientParty]:
        """Returns either :class:`vodajemokra.Friend` or
        :class:`vodajemokra.ClientParty` where the help command will be output.
