"""Метакласс проверки connect, TCP, IPv4"""
...
class ServerMaker(type):
    ...
    нет клиентских вызовов таких как: connect. Также проверяется,
    что серверный сокет является TCP и работает по IPv4 протоколу.
    """
    ...
    def __init__(cls, clsname, bases, clsdict):
        ...
        for func in clsdict:
            ...
            try:
                ...
                # ret - <generator
                # object _get_instructions_bytes at 0x00000062EAEAD7C8>
                # ret - <generator
                # object _get_instructions_bytes at 0x00000062EAEADF48>
                # ...
...
class ClientMaker(type):
    """
    Метакласс, проверяющий что в результирующем классе
    нет серверных вызовов таких как: accept, listen. Также проверяется,
    что сокет не создаётся внутри конструктора класса.
    """
