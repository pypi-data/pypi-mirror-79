...
from fixedrobo import helpers
from fixedrobo import exceptions
from fixedrobo.compat import urlparse
from fixedrobo.forms.form import Form
from fixedrobo.cache import RoboHTTPAdapter
...
class WebScraper(object):
    ...
    def __repr__(self):
        try:
            return '<WebScraper url={0}>'.format(self.url)
