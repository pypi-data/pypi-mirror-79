...
**NOTE:** If this is your first time connecting to an NXBT emulated controller on the specific host computer, you **MUST** have the "Change Grip/Order Menu" open on your Nintendo Switch.
...
Once you've successfully connected to the Nintendo Switch, you should see a new webpage with multiple options available.
...
A loading screen should open and, once connected, the main TUI control screen should load.
...
For info on writing macros, check out the documentation [here](https://github.com/Brikwerk/nxbt/blob/master/docs/Macros.md).
