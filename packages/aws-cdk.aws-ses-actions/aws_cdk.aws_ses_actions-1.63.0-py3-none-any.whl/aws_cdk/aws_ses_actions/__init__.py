...
class AddHeader(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ses-actions.AddHeader"
):
    ...
    def bind(
        self, _rule: aws_cdk.aws_ses.IReceiptRule
...
class BounceTemplate(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ses-actions.BounceTemplate"
):
    """A bounce template.
...
class Lambda(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ses-actions.Lambda"):
    ...
    @jsii.member(jsii_name="bind")
    def bind(
        self, rule: aws_cdk.aws_ses.IReceiptRule
    ) -> aws_cdk.aws_ses.ReceiptRuleActionConfig:
        """Returns the receipt rule action specification.
...
class Stop(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ses-actions.Stop"):
    ...
    def __init__(
        self, *, topic: typing.Optional[aws_cdk.aws_sns.ITopic] = None
    ) -> None:
        """
