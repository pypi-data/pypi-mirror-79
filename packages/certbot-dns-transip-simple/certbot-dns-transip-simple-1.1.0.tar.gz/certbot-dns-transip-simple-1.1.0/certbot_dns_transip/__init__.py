...
========================================  =====================================
``--dns-transip-credentials``           transip Remote API credentials_
                                          INI file. (Required)
``--dns-transip-propagation-seconds``   The number of seconds to wait for DNS
...
Use of this plugin requires a configuration file containing transip Remote API
credentials, obtained from your transip account
`https://www.transip.be/cp/account/api/`
...
.. code-block:: ini
   ...
   dns_transip_username = myispremoteuser
   dns_transip_api_key = transip_api_key

The path to this file can be provided interactively or using the
``--dns-transip-credentials`` command-line argument. Certbot records the path
