...
STYLE_PENCIL = style_default(
    tool_line=tool.line_sharp_pencil,
    brush='pencil.png',
)
...
STYLE = defaultdict(lambda: STYLE_UNKNOWN_TOOL, {
    ...
    # Ballpoint
    Pen.BALLPOINT_1: style_default(tool_line=tool.line_ballpoint),
    Pen.BALLPOINT_2: style_default(tool_line=tool.line_ballpoint),

    # Fineliner
    Pen.FINELINER_1: style_default(tool_line=tool.line_fineliner),
    Pen.FINELINER_2: style_default(tool_line=tool.line_fineliner),

    # Highlighter
    Pen.HIGHLIGHTER_1: STYLE_HIGHLIGHTER,
    Pen.HIGHLIGHTER_2: STYLE_HIGHLIGHTER,

    # Eraser
    Pen.ERASER: STYLE_ERASER,

    # Sharp pencil
    Pen.SHARP_PENCIL_1: STYLE_PENCIL,
    Pen.SHARP_PENCIL_2: STYLE_PENCIL,

    # Erase area
    Pen.ERASER_AREA: STYLE_ERASER._replace(tool_line=tool.line_erase_area),
})
