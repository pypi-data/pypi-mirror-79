...
from .data import PEN_WIDTH_UKNOWN, PEN_WIDTH_HIGHLIGHTER, PEN_WIDTH_ERASE_AREA
...
line_unknown = partial(single_line, lambda s: PEN_WIDTH_UKNOWN)
...
line_highlighter = partial(single_line, lambda s: PEN_WIDTH_HIGHLIGHTER)
line_eraser = partial(single_line, calc_width_eraser)
line_erase_area = partial(single_line, lambda s: PEN_WIDTH_ERASE_AREA)
