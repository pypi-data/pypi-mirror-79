...
from .efficientdet.model import BiFPN, Center_layer, EfficientNet, SeparableConvBlock
...
class QuadNet(nn.Module):
    def __init__(self, compound_coef=0, load_weights=False, **kwargs):
        ...
        self.center = Center_layer(in_channels=self.fpn_num_filters[self.compound_coef])
