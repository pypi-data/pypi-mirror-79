...
class OnlineTrajectoryHandler(object):
    ...
    def __init__(self,
        ...
        self.__v_start = 0.0
        self.__vx_old = None
        self.__vx_follow_old = None
        self.__action_id_old = 'left'
    ...
    def set_initial_pose(self,
        ...
        self.__last_action_set_coeff = {"straight": [np.hstack((x_coeff, y_coeff))]}
        self.__last_action_set_path_param = {"straight": [np.column_stack((path, psi, kappa,
                                                                           np.append(el_lengths, 0)))]}
        self.__last_action_set_nodes = {"straight": [[[None, None], self.__start_node]]}
        self.__last_action_set_node_idx = {"straight": [[0, path.shape[0] - 1]]}
