...
class HtmlText(BaseHtmlText):
	def __init__(self, obj, ignore_function=None, log=False, num_jobs=1):
		super().__init__(obj=obj, id='1', ignore_function=ignore_function, depth=0, _ids=None, log=log, num_jobs=num_jobs)
		self._data = None
