...
Coroutine is very similar with Future/Futures but use '@app.coroutine'
and 'yield'.

I think Future(s) will be deprecated soon.

You can think 'yield' as 'await'.
...
*Note:* Use 'Coroutine Response' for more easy usage.
