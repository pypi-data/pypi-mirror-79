...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import (
    AllFeaturesAreExcluded, ConflictingValueForArguments, DatasetsFeatureCountMismatch, DataShapeMismatch,
    ExperimentTimeoutForDataSize, FeatureUnsupportedForIncompatibleArguments, FeaturizationConfigColumnMissing,
    FeaturizationRequired, InputDatasetEmpty, InsufficientSampleSize, InvalidArgumentWithSupportedValues,
    InvalidInputDatatype, MissingColumnsInData, MissingValidationConfig, NCrossValidationsExceedsTrainingRows,
    UnrecognizedFeatures, InconsistentColumnTypeInTrainValid, InvalidArgumentType, OnnxUnsupportedDatatype,
    SampleCountMismatch, IndistinctLabelColumn, DatasetContainsInf, SampleWeightsUnsupported, UnhashableValueInColumn,
    NonOverlappingColumnsInTrainValid, DuplicateColumns, InvalidValuesInCVSplitColumn)
...
def set_task_parameters(y: DataInputType, automl_settings: AutoMLBaseSettings) -> None:
    """
    ...
    :param automl_settings: The settings used for this current run.
    :return: None.
    :raises: `ValidationException` in case of type errors. `InsufficientDataException`.
    in case of not enough data available.
    """
