...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import TimeseriesInvalidDateOffsetType
...
def fix_data_set_regularity_may_be(
        ...
        grain_column_names: Optional[Union[List[str], str]],
        user_frequency: Optional[pd.DateOffset] = None
) -> Tuple[pd.DataFrame, Optional[DataSingleColumnInputType], bool, bool]:
    """
