...
from azureml.automl.core.shared.exceptions import (
    AutoMLException, ClientException, DataException, DataSamplesSizeException)
    ...
    def learn_transformations(self) -> StreamingFeaturizationTransformer:
        ...
        if len_subsampled_input_columns != len_training_data_columns:
            ...
            raise DataSamplesSizeException(
                msg.format(len_training_data_columns, len_subsampled_input_columns)).with_generic_msg(
