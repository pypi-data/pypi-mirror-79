/*! For license information please see chunk.a111edf8b31facdfa282.js.LICENSE.txt */
(self.webpackJsonp=self.webpackJsonp||[]).push([[146],{184:function(e,t,i){"use strict";i(5),i(47),i(56),i(140);var r=i(6),o=i(4),n=i(101);Object(r.a)({_template:o.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[n.a]})},257:function(e,t,i){"use strict";i(5),i(47);var r=i(6),o=i(3),n=i(4),a=i(163);Object(r.a)({_template:n.a`
    <style>
      :host {
        display: block;
        /**
...
`,is:"app-header-layout",behaviors:[a.a],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return Object(o.a)(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var e=this.header;if(this.isAttached&&e){this.$.wrapper.classList.remove("initializing"),e.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var t=e.offsetHeight;this.hasScrollingRegion?(e.style.left="",e.style.right=""):requestAnimationFrame(function(){var t=this.getBoundingClientRect(),i=document.documentElement.clientWidth-t.right;e.style.left=t.left+"px",e.style.right=i+"px"}.bind(this));var i=this.$.contentContainer.style;e.fixed&&!e.condenses&&this.hasScrollingRegion?(i.marginTop=t+"px",i.paddingTop=""):(i.paddingTop=t+"px",i.marginTop="")}}})},296:function(e,t,i){"use strict";i(257);var r=i(4);i(32);class o extends(customElements.get("app-header-layout")){static get template(){return r.a`
      ...
      ${this.cloudStatus&&Object(o.a)(this.hass,"cloud")?r.f`
            <ha-card>
              <ha-config-navigation
                .hass=${this.hass}
                .showAdvanced=${this.showAdvanced}
                .pages=${[{component:"cloud",path:"/config/cloud",translationKey:"ui.panel.config.cloud.caption",info:this.cloudStatus,iconPath:s.A}]}
              ></ha-config-navigation>
            </ha-card>
          `:""}
    ...
    `:e}},{kind:"get",static:!0,key:"styles",value:function(){return[n.c,r.c`
      ...
      `]}}]}}),r.a)}}]);
//# sourceMappingURL=chunk.a111edf8b31facdfa282.js.map