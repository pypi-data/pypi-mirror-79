...
`},263:function(e,t){},305:function(e,t,i){"use strict";i.r(t),i.d(t,"sortableStyles",(function(){return r}));const r=i(0).c`
      ...
      <div class="entities">
        ${Object(o.a)([this.entities,this._renderEmptySortable],()=>this._renderEmptySortable?"":this.entities.map((e,t)=>n.f`
                  <div class="entity" data-entity-id=${e.entity}>
                    <ha-svg-icon .path=${r.J}></ha-svg-icon>
                    <ha-entity-picker
                      .hass=${this.hass}
                      .value=${e.entity}
                      .index=${t}
...
//# sourceMappingURL=chunk.df09ba7f862d5d9d6fc9.js.map