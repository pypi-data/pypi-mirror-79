...
def r_smooth_loop(input_dir, output_dir, trial_type):
    ...
    with open(output_dir + 'smooth.r', 'w') as f:
        ...
        for file in files:
            ...
            print('write.csv(df, "' + file.strip('.csv') +
                  '_smoothed.csv" , row.names = FALSE)', file=f)
