...
class ServerResourcesSchema(object):
    ...
    def __init__(self, cpu='500m', max_replicas=3, memory='0.5Gi', min_replicas=2, object='resources', **kwargs):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, cpu='500m', max_replicas=3, memory='0.5Gi', min_replicas=2, object='resources', **kwargs):  # noqa: E501
