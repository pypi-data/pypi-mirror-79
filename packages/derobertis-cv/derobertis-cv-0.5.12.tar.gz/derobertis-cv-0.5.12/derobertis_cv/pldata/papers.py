...
def get_working_papers():
    ...
    currency drives the valuation. I analyze attention, sentiment, and R&D measures 
    as proxies for this expectation and find that they are all significantly related to cryptoasset 
    returns. A portfolio which was long high attention cryptocurrencies and short low attention cryptocurrencies
    would have earned 80x returns from mid-2017 to the end of 2019 (477% annualized return), though this
    is not yet a tradeable strategy due to short-sale constraints. Sentiment and R&D do not show as strong
    of effects but are still significantly related, and all remain significant with a variety of analyses
    and controls including other crypto market factors such as $MKT_c$, $SMB_c$, and $UMD_c$
    and dual portfolio sorts on maturity, size, and momentum.
    """
    crypto_description = (
        crypto_latex_description
            .replace('$MKT_c$', 'MKT')
