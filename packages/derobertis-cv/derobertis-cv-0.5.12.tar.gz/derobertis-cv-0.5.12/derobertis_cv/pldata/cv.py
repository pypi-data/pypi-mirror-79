...
def get_cv_contents(model: CVModel) -> List[ItemBase]:
    ...
    selected_contents = [
        pl.Raw(r'\vspace*{-4cm}\includegraphics[width=3.85cm, height=4cm]{' + images_path('nick-derobertis.png') + '}'),
        pl.Raw(r'\vbox{\hspace{9.15cm} \vspace*{2.025cm} \includegraphics[width=1.29cm, height=1.5cm]{' + images_path('nd-logo.png') + '}}'),
    ]
