...
class UnifiedAPI():
	...
	def Retrieval(self,payment_type,invoice,ecr_ref,transData,printOut):
		...
		if payment_type == "QR":
			...
			result = retrievalTerminal(payment_type,invoice,transData,printOut,props)
	...
	def Membership(self,payment_type,ecr_ref,option,amount,ciamID,transData,printOut):
		...
		if payment_type == "EDC" or payment_type == "VAC":
			result = membershipTerminal(payment_type,ecr_ref,option,amount,ciamID,transData,printOut,props)
