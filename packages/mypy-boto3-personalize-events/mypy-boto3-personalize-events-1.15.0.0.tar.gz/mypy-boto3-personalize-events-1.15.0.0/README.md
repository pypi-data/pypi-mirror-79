...
[boto3.PersonalizeEvents 1.15.0](https://boto3.amazonaws.com/v1/documentation/api/1.15.0/reference/services/personalize-events.html#PersonalizeEvents) service
compatible with
