...
[boto3.PersonalizeEvents 1.14.58](https://boto3.amazonaws.com/v1/documentation/api/1.14.58/reference/services/personalize-events.html#PersonalizeEvents) service
compatible with
