...
def checkFileParams(fileParams):
    ...
    if 'filePath' not in fileParams:
        raise Warning("fileParams has to be a dictionary with filePath for the data source\n"
    ...
    if fileExtension in supportedExtensions:
        ...
        if fileExtension != 'txt' and 'column' not in fileParams:
            ...
            return filePath, fileExtension, txtSeperator
        
        return filePath, fileExtension, fileParams['column']
