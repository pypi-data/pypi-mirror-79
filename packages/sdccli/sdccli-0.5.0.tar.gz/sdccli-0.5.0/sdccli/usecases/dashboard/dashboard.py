...
def share_dashboard_with_all_teams(monitor: SdMonitorClient, dashboard, mode):
...
def share_dashboard_with_team(monitor: SdMonitorClient, dashboard, team_id, mode):
...
def unshare_dashboard(monitor: SdMonitorClient, dashboard):
...
def favorite_dashboard(monitor: SdMonitorClient, dashboard, favorite):
