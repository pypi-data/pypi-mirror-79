...
class CodeBuildStartBuild(
    ...
    def __init__(
        ...
        *,
        ...
        environment_variables_override: typing.Optional[typing.Mapping[str, aws_cdk.aws_codebuild.BuildEnvironmentVariable]] = None,
        comment: typing.Optional[str] = None,
        heartbeat: typing.Optional[aws_cdk.core.Duration] = None,
        input_path: typing.Optional[str] = None,
        integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern] = None,
...
class CodeBuildStartBuildProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    ...
    def environment_variables_override(
        ...
        """
        return self._values.get("environment_variables_override")
...
class DynamoDeleteItem(
    ...
    def __init__(
        ...
        *,
        ...
        expression_attribute_values: typing.Optional[typing.Mapping[str, "DynamoAttributeValue"]] = None,
