...
class DynamoDbCoreAdapter:
    ...
    def _put_item_dict(self, item_dict: dict) -> Response:
        try:
    ...
    def _get_item_by_primary_key(self, key_name: str, key_value: any, fields_to_get: Optional[List[str]]) -> Optional[GetItemResponse]:
    ...
    def _add_data_elements_to_list(self, key_name: str, key_value: Any, object_path: str,
    ...
    def _remove_data_elements_from_list(self, key_name: str, key_value: Any, list_object_path: str,
    ...
    def _initialize_all_elements_in_map_target(self, key_name: str, key_value: Any, object_path_elements: Dict[str, type]) -> bool:
        current_path_target = ""
    ...
    def _add_update_data_element_to_map(self, key_name: str, key_value: Any,
        ...
        if response is None:
            ...
            success: bool = self._initialize_all_elements_in_map_target(
    ...
    def _add_update_multiple_data_elements_to_map(self, key_name: str, key_value: Any,
    ...
    def _query_by_key(self, key_name: str, key_value: Any, index_name: Optional[str] = None,
    ...
    def _query_single_item_by_key(self, key_name: str, key_value: Any, index_name: Optional[str] = None,
    ...
    def _get_data_in_path_target(self, key_name: str, key_value: str, target_path_elements: Dict[str, type],
        ...
        response_item: Optional[dict] = self._get_item_by_primary_key(
    ...
    def _get_value_in_path_target(self, key_name: str, key_value: str, target_path_elements: Dict[str, type]) -> Optional[any]:
        return self._get_data_in_path_target(
    ...
    def _get_item_in_path_target(self, key_name: str, key_value: str, target_path_elements: Dict[str, type]) -> Optional[dict]:
        return self._get_data_in_path_target(
            key_name=key_name, key_value=key_value,
            target_path_elements=target_path_elements,
