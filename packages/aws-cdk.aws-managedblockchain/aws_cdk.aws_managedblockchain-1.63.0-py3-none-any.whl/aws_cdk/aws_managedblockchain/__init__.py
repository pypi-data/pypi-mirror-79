...
class CfnMember(
    ...
    def __init__(
        ...
        id: str,
        *,
        member_configuration: typing.Union["MemberConfigurationProperty", aws_cdk.core.IResolvable],
...
class CfnNode(
    ...
    def __init__(
        ...
        *,
        member_id: str,
        network_id: str,
        node_configuration: typing.Union[aws_cdk.core.IResolvable, "NodeConfigurationProperty"],
    ) -> None:
    ...
    def node_configuration(
        self,
        value: typing.Union[aws_cdk.core.IResolvable, "NodeConfigurationProperty"],
    ) -> None:
