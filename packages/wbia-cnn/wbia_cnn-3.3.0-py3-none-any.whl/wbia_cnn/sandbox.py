...
def check_external_training_paths():
    ...
    checkpoints_dir = (
        '/home/joncrall/.config/wbia_cnn/training_junction/liberty/checkpoints'
    )
...
def load_tmp_model():
    ...
    fpath = (
        '/home/joncrall/.config/wbia_cnn/training_junction/liberty/model_state_dozer.pkl'
    )
...
def theano_gradient_funtimes():
    ...
    learning_rate_theano = 0.0001
    momentum = 0.9
    updates = lasagne.updates.nesterov_momentum(
        gradients_regularized, parameters, learning_rate_theano, momentum
    )
