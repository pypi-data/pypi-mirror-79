...
class LabelerModel(abstract_models.AbstractCategoricalModel):
    def __init__(
        ...
        **kwargs
        ...
        super(LabelerModel, model).__init__(
...
def train_labeler(output_path, data_fpath, labels_fpath):
    ...
    dataset = ingest_data.get_numpy_dataset2(
        'labeler', data_fpath, labels_fpath, output_path
    )
...
if __name__ == '__main__':
    """
    CommandLine:
        python -m wbia_cnn.models.labeler
        python -m wbia_cnn.models.labeler --allexamples
        python -m wbia_cnn.models.labeler --allexamples --noface --nosrc
    """
