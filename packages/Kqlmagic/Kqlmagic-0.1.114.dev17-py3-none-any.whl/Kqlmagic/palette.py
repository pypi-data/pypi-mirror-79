...
class Palette(list):
    ...
    def _get_color_palette(cls, name=None, n_colors=1, desaturation=1):
        if name in cls.DEFAULT_PALETTES:       
            default_palette = cls.DEFAULT_PALETTES[name]
            ...
            if name in cls.MATPLOTLIB_DISTINCT_PALETTES:
                num = cls.MATPLOTLIB_DISTINCT_PALETTES[name]
