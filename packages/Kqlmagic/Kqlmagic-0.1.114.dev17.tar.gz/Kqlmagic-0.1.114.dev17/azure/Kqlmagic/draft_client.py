...
class DraftClient(KqlClient):
    ...
    def execute(self, id: str, query: str, accept_partial_results: bool = False, **options) -> object:
        ...
        if is_metadata:
            ...
            # collect this inormation, in case bug report will be generated
            self.last_query["request"]["payload"] = request_payload # pylint: disable=unsupported-assignment-operation, unsubscriptable-object
        ...
        #
        # collect this inormation, in case bug report will be generated
        self.last_query["response"] = { # pylint: disable=unsupported-assignment-operation
        ...
        if response.status_code != requests.codes.ok:  # pylint: disable=E1101
            ...
            # collect this inormation, in case bug report will be generated
            self.last_query["response"]["error"] = parsed_error # pylint: disable=unsupported-assignment-operation, unsubscriptable-object
