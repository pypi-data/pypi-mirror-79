...
class MsalTokenCache(SerializableTokenCache):
    ...
    def __init__(self, store: SsoStorage, state: str=None):
        ...
        with self._rlock:
            ...
            if state:
                ...
                if      state_obj.get("description") == "kqlmagic" and \
                        state_obj.get("version") == 2 and \
                        state_obj.get("package") == "msal" and \
                        ...
                        state_obj.get("cache_state") is not None:
