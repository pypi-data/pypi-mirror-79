...
class DictDbStorage(object):
    ...
    def __init__(self, db, sso_options: dict, state=None):
    ...
    def _get_db_key_prefix(self, sso_options: dict) -> str:
        """key_prefix: kqlmagicstore/tokens/<cache_name>/<user_name>"""

        path_args = [
            Constants.SSO_DB_KEY_PREFIX,
            sso_options.get(SsoStorageParam.CACHE_NAME, 'sso')
        ]
    ...
    def _get_db_key(self, db_key_prefix: str, cache_selector_key: str) -> str:
        """key: kqlmagicstore/tokens/<cache_name>/<user_name>/<cache_selector>"""
