...
class Display(object):
    ...
    def _get_window_html(window_name, file_path_or_data, button_text=None, onclick_visibility=None, isText=None, palette=None, before_text=None, after_text=None, close_window_timeout_in_secs=None, close_itself_timeout_in_secs=None, content=None, options={}):
        ...
        if host_or_text != 'text' and options.get("notebook_app") in ["azuremljupyternotebook", "azuremljupyterlab", "azureml"]:
            ...
            file_path_or_data =  base64.b64encode(file_path_or_data.encode('ascii')).decode('ascii')
            isText = True
            host_or_text = 'body'
        ...
        html_str = (
            ...
            kql_MagicLaunchWindowFunction('{file_path_or_data}', '{window_params}', '{window_name}', '{host_or_text}');
