...
class KustoEngine(KqlEngine):
    ...
    def __init__(self, conn_str, user_ns: dict, current=None, conn_class=None,  **options):
        ...
        if isinstance(conn_str, dict):
            ...
            self.cluster_friendly_name = conn_str.get(ConnStrKeys.CLUSTER_FRIENDLY_NAME)
            ...
            self.client = KustoClient(self._parsed_conn, **options)
    ...
    def get_details(self):
        if self.client is None:
            ...
            details = cluster_connection.get_details()
