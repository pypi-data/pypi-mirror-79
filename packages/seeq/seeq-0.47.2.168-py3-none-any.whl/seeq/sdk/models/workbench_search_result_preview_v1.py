...
class WorkbenchSearchResultPreviewV1(object):
    ...
    def __init__(self, ancestors=None, created_at=None, data=None, description=None, effective_permissions=None, headline=None, id=None, is_pinned=False, name=None, owner=None, parent_folder_id=None, type=None, updated_at=None):
        """
