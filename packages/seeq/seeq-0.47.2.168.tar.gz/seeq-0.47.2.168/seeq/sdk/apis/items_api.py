...
class ItemsApi(object):
    ...
    def search_workbench(self, **kwargs):
        ...
        :param str text_search: Search text by which to filter item's names. If multiple words are supplied they are treated separately and can be anywhere in the name. If text is enclosed by double quotes it will be searched exactly as given.
