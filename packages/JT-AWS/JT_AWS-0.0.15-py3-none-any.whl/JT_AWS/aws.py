...
def OpenSession(cred_path: str = None, region: str = None):
    """
    TODO: Add docstring
...
def OpenEC2Client(cred_path: str = None, region: str = None):
    """
...
def OpenEC2Resource(cred_path: str = None, region: str = None):
    """
    Open a boto3 EC2 resource using the specified credentials in the specified region
...
def OpenLambdaClient(cred_path: str = None, region: str = None):
    """
...
def OpenLambdaResource(cred_path: str = None, region: str = None):
    """
...
def OpenS3Client(cred_path: str = None, region: str = None):
    """
...
class EC2_Client:
    def __init__(self, cred_path: str = None, region: str = None):
        """
...
class Lambda_Client:
    def __init__(self, bucket_name: str, cred_path: str = None, region: str = None):
        """
        Open a boto3 EC2 client using the specified credentials in the specified region
        ...
        :return:
        """
        self.client = OpenLambdaClient(
            cred_path=cred_path,
            region=region
        )
        self.s3 = OpenS3Client(
            cred_path=cred_path,
            region=region
        )
