...
def BlobFile(path: str, mode: Literal['r', 'rb', 'w', 'wb', 'a', 'ab']=..., streaming: Optional[bool]=..., buffer_size: int=..., cache_dir: Optional[str]=...):
  ...
@overload
def LocalBlobFile(path: str, mode: Literal['rb', 'wb', 'ab'], buffer_size: int=..., cache_dir: Optional[str]=...) -> BinaryIO:
  ...
@overload
def LocalBlobFile(path: str, mode: Literal['r', 'w', 'a']=..., buffer_size: int=..., cache_dir: Optional[str]=...) -> TextIO:
  ...
