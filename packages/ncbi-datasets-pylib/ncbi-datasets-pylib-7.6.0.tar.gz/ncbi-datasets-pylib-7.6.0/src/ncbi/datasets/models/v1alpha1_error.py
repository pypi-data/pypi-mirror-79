...
class V1alpha1Error(object):
    ...
    openapi_types = {
        ...
        'message': 'str',
        'reason': 'str',
        'replaced_ids': 'list[ErrorReplacedId]',
    ...
    def __init__(self, assembly_error_code=None, gene_error_code=None, invalid_identifiers=None, message=None, reason=None, replaced_ids=None, valid_identifiers=None, virus_error_code=None, local_vars_configuration=None):  # noqa: E501
    ...
    def replaced_ids(self):
        """Gets the replaced_ids of this V1alpha1Error.  # noqa: E501


        :return: The replaced_ids of this V1alpha1Error.  # noqa: E501
        :rtype: list[ErrorReplacedId]
        """
        return self._replaced_ids

    @replaced_ids.setter
    def replaced_ids(self, replaced_ids):
        """Sets the replaced_ids of this V1alpha1Error.


        :param replaced_ids: The replaced_ids of this V1alpha1Error.  # noqa: E501
        :type: list[ErrorReplacedId]
        """
