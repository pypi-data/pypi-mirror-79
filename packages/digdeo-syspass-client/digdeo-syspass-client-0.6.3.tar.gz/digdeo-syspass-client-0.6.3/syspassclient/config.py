...
class Config(syspassclient.Libs):
    ...
    def display_resume(self):
        ...
        # API_URL
        if (
            "DD_SYSPASS_CLIENT_API_URL" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_API_URL"])
            )
        elif self.api_url:
        ...
        # API_VERSION
        if (
            "DD_SYSPASS_CLIENT_API_VERSION" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_API_VERSION"])
            )
        else:
            print(
        ...
        # AUTH_TOKEN
        if (
            "DD_SYSPASS_CLIENT_AUTH_TOKEN" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_AUTH_TOKEN"])
            )
        elif self.authToken:
        ...
        # TOKEN_PASS
        if (
            "DD_SYSPASS_CLIENT_TOKEN_PASS" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_TOKEN_PASS"])
            )
        elif self.tokenPass:
        ...
        # VERIFY_SSL
        if (
            "DD_SYSPASS_CLIENT_VERIFY_SSL" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_VERIFY_SSL"])
            )
        ...
        # DEBUG
        if (
            "DD_SYSPASS_CLIENT_DEBUG" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_DEBUG"])
            )
        else:
        ...
        # DEBUG_LEVEL
        if (
            "DD_SYSPASS_CLIENT_DEBUG_LEVEL" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_DEBUG_LEVEL"])
            )
        else:
            print(
        ...
        # VERBOSE
        if (
            "DD_SYSPASS_CLIENT_VERBOSE" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_VERBOSE"])
            )
        else:
        ...
        # VERBOSE_LEVEL
        if (
            "DD_SYSPASS_CLIENT_VERBOSE_LEVEL" in os.environ
            ...
            print(
                Fore.GREEN
                + Style.BRIGHT
                + "{0}".format(os.environ["DD_SYSPASS_CLIENT_VERBOSE_LEVEL"])
            )
        else:
            print(
