...
class Object(object):
    ...
    def verbose(self):
        ...
        if (
            ...
            return bool(os.environ["syspass_verbose"])
    ...
    def verbose_level(self):
        ...
        if (
            ...
            return int(os.environ["syspass_verbose_level"])
    ...
    def debug(self):
        ...
        if (
            ...
            return bool(os.environ["syspass_debug"])
        return self.__debug
    ...
    def debug_level(self):
        ...
        if (
            ...
            return int(os.environ["syspass_debug_LEVEL"])
