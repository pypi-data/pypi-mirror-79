...
Usage:
  ...
  phases run <phaseName> [-p <projectfile>] [-c <configfile>] [-o <outputdir>] [-v]
  phases -h | --help
  phases --version
Options:
...
def main():
    ...
    Logger.log("Phases %s wiath pyPhases (Log level: %s)"%(VERSION, pyPhases.__version__, Logger.verboseLevel))
