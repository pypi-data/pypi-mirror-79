...
class PreviewSection(CollapsibleSection):
    ...
    def __init__(self, dialog):
        ...
        super(PreviewSection, self).__init__(dialog, "Preview", collapse=False, override_color=c4d.Vector(0.2, 1,0.2))
    ...
    def on_plugin_message(self, widget_id, msg):
        if widget_id in self.affectors:
            with_assets = widget_id == self.dialog.section(
                "AssetsSection").preview_button_id
