...
class OpenADRClient:
    ...
    def __init__(self, ven_name, vtn_url, debug=False, cert=None, key=None, passphrase=None, verification_cert=None):
        ...
        :param str certificate_file: The PEM-formatted Certificate File to use for signing messages
        :param str key_file: The PEM-formatted Private Key file to use for signing messages
        :param verification_certificate: The PEM-formatted Certificate File to use for verifying incoming messages.
        """
