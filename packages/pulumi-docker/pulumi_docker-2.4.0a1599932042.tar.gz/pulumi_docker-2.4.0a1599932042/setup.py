...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.4.0-alpha.1599932042+0409a4d4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.4.0-alpha.1599932042+0409a4d4`
                """)
            else:
                raise
