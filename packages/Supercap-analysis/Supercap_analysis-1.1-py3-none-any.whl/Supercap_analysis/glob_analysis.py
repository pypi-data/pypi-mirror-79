...
def Glob_analysis(path, t_set = False, V_set = False, delimiter = False, mass_ls = False, row_skip = False, ESR_method = True, setting = False, plotting = True):
    ...
    supc_ls = [Load_capacitor(i, t_set = t_set, V_set = V_set, delimiter = delimeter, mass_ls = mass_ls, row_skip = row_skip, ESR_method = ESR_method, setting = setting) for i in Glob_set]
