...
<div id="Installation">
    ...
    <p>
        Please follow the instruction on the left top corner of the page using command prompt 
   </p>
</div>
...
```python
>>>Load_capacitor('./GCD/3.0_mA_1.5V.csv', t_set = 'time', V_set = voltage, current = False, ESR_method = 201)
<Class_Supercap: 3.0 mA, 1.5 V, 9 cycles, ESR method 201>
```
