...
class Holding(object):
    ...
    def __create_position(self):
        ...
        try:
            ...
            session.commit()
            session.close()
            msg = "创建仓位信息, {}".format(str(self.__dict__))
            LogHelper.info(msg)
        except Exception as ex:
            LogHelper.error("创建仓位信息出错", traceback.format_exc())
...
class TerminalServer(object):
    ...
    def __init__(self, mysql_conn):
        ...
        LogHelper.info("连接的mysql_conn: {}".format(str(self.__dict__)))
    ...
    def get_conn_from_env(self):
        ...
        if "MySQL_Session" in os.environ:
            ...
            LogHelper.warn("没有配置MySQL_Session环境变量")
...
class DataServer(object):
    ...
    def __init__(self, pg_conn):
        ...
        LogHelper.info("连接的data_server: {}".format(str(self.__dict__)))
    ...
    def get_conn_from_env(self):
        ...
        if "PostgreSQL_Session" in os.environ:
            ...
            LogHelper.warn("没有配置PostgreSQL_Session环境变量")
...
class WebSocket(object):
    ...
    def __init__(self, websocket_conn):
        ...
        LogHelper.info("websocket的连接: {}".format(str(self.__dict__)))
    ...
    def get_conn_from_env(self):
        ...
        if "Websocket" in os.environ:
            ...
            LogHelper.warn("没有配置Websocket环境变量")
...
class IBOrder(object):
    ...
    def __init__(self, order_conn):
        ...
        LogHelper.info("连接的order_server: {}".format(str(self.__dict__)))
    ...
    def get_conn_from_env(self):
        ...
        if "Order_Server" in os.environ:
            ...
            LogHelper.warn("没有配置Order_Server环境变量")
