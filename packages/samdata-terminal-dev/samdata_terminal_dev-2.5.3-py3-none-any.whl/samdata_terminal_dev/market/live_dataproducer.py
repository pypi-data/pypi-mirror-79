...
class IBDataApi(threading.Thread):
    ...
    def on_message(self, message):
        try:
            ...
            LogHelper.error("处理websocket的数据出错", traceback.format_exc())
    ...
    def on_error(self, error):
        ...
        if type(error) == ConnectionRefusedError or type(error) == websocket._exceptions.WebSocketConnectionClosedException:
            ...
            LogHelper.error("websocket出现其他error: {}".format(str(error)))
    ...
    def on_open(self):
        ...
        try:
            ...
            LogHelper.error("on_open", traceback.print_exc())
    ...
    def run(self):
        ...
        try:
            ...
            LogHelper.error("连接IB websocket出错", traceback.format_exc())
