...
class LogConsummer(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            LogHelper.error("更新数据库的日志信息，出错", traceback.print_exc())
...
class OrderConsummer(threading.Thread):
    ...
    def run(self):
        try:
            ...
            LogHelper.error("更新数据库的订单数据，出错", traceback.print_exc())
...
class DataConsumer(threading.Thread):
    ...
    def run(self):
        try:
            ...
            LogHelper.error("数据消费者： 数据处理出错", traceback.print_exc())
    ...
    def consume_kline_data(self):
        ...
        try:
            ...
            LogHelper.error("消费k线数据时出错", traceback.print_exc())
    ...
    def consume_other_data(self):
        ...
        try:
            ...
            LogHelper.error("消费其他类型数据时出错", traceback.print_exc())
