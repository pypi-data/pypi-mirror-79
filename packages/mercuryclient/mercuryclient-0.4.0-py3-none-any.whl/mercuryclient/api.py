...
from .mixins import AuthMixin, MailMixin, SMSMixin, ExperianMixin


class MercuryApi(AuthMixin, MailMixin, SMSMixin, ExperianMixin):
    """
    ...
    def _post_json_http_request(
        self, url, data, headers=None, send_request_id=True, add_bearer_token=True
    ):
        """

        :param url: URL to send the HTTP POST
        :param data: dict to be sent as JSON in the HTTP body
        :param headers: headers for the request
        :param send_request_id: Defaults to True. Indicates if a request Id has to generated for the request
        :param add_bearer_token: Defaults to True. If True, we will add the bearer token to the request
    ...
    def _get_json_http_request(
        self, url, headers=None, send_request_id=True, add_bearer_token=True
    ):
        """
        Perform GET request on the provided URL

        :param url: URL to send HTTP GET
        :type url: str
        :param headers: Headers for the request, defaults to None
        :type headers: dict, optional
        :param send_request_id: Indicates if a request ID has to be generated for the request, defaults to True
        :type send_request_id: bool, optional
        :param add_bearer_token: If True, will add a bearer token to the request, defaults to True
