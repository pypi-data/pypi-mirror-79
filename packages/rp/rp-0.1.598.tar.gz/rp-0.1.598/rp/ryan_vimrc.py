...
"Below is a lighter-weight alternative to csv.vim, that simply provides syntax highlighting instead of all the other fancy features that csv.vim provides:
