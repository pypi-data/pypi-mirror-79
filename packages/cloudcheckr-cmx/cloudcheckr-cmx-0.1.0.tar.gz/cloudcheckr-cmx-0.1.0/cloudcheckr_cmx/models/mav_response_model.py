...
class MavResponseModel(object):
    ...
    def __init__(self, legacy_account_id=None, provider_identifier=None, provider_sub_type=None, provider_payment_type=None, payer_identifier=None, include_all_accounts=None, associated_account_attributes=None, type=None, provider=None, has_pending_change=None, id=None, name=None):  # noqa: E501
