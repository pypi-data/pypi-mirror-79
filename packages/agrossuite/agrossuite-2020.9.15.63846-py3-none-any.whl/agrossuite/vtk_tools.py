...
def show(problem, field, variable, component, time_step=0, adaptive_step=0, width=600, height=400):
    ...
    scalar = vtk_scalar_actor(temp_post_name)
    contours = vtk_contours_actor(temp_post_name)    
    
    fig = vtk_figure(geometry=geometry, scalar=scalar, contours=contours, width=width, height=height)
