# import pytest
#
# from w.services.technical.google_recaptcha_service import GoogleRecaptchaService
...
#         }
#
#         with request_test_helper.mock_request(response, method="post") as m:
#             assert 0.9 == GoogleRecaptchaService.verify_token("good_token")
