...
from wedge.services.technical.models.request_response import RequestResponse
from wedge.services.technical.models.request_session import RequestSession
...
class TestRequestService(TestCaseMixin):
    ...
    def fix_response_variable_content(response):
        ...
        # remove all headers beginnig by X-
