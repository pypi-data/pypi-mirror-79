...
from w.tests.fixtures.datasets.builders.builder_fake_django_model import (
    BuilderFakeDjangoModelWithForeignKey,
)
from w.tests.fixtures.datasets.builders.builder_with_auto_now import BuilderWithAutoNow
...
class TestTestBuilder(TestCaseMixin):
    ...
    def test_build_post_data_with_django_model(self):
        ...
        target = (
            "w.tests.builders.abstract_test_builder"
