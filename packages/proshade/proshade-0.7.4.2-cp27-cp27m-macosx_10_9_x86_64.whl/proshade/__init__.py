...
class ProSHADE_data(object):
    ...
    def detectSymmetryInStructure(self, settings, axes):
        return _proshade.ProSHADE_data_detectSymmetryInStructure(self, settings, axes)
    ...
    def getNoSymmetryAxes(self, settings):
        return _proshade.ProSHADE_data_getNoSymmetryAxes(self, settings)
