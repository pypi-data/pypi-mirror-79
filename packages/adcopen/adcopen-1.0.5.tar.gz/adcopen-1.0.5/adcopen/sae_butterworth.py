...
def butter_lowpass(cutoff:float, sample_rate_hz:int, order:int=2) ->Tuple[np.ndarray,np.ndarray]:
    """
...
def butter_lowpass_filter(data:typing.Any, cutoff:float, sample_rate_hz:int, order:int=2) -> tuple:
    """
