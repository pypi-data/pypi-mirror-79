...
**24. maads.viperproducetotopic(vipertoken,host,port,topic,producerid,enabletls=0,inputdata='',maadsalgokey='',maadstoken='',getoptimal=0,externalprediction='',brokerhost='',brokerport=-999,microserviceid='')**
...
**25. maads.viperconsumefromtopic(vipertoken,host,port,topic,consumerid,companyname,enabletls=0,offset=0,brokerhost='',brokerport=-999,microserviceid='')**
...
**26. maads.viperhpdepredict(vipertoken,host,port,consumefrom,produceto,companyname,consumerid,producerid,hpdehost,enabletls=0,
...
**27. maads.viperhpdeoptimize(vipertoken,host,port,consumefrom,produceto,companyname,consumerid,producerid,hpdehost,enabletls=0,hpdeport=-999,usedeploy=0,
...
**29. maads.viperproducetotopicstream(vipertoken,host,port,topic,producerid,offset,enabletls=0,brokerhost='',brokerport=-999,microserviceid='')**
...
**32. maads.viperconsumefromstreamtopic(vipertoken,host,port,topic,consumerid,companyname,enabletls=0,offset=0,brokerhost='',brokerport=-999,microserviceid='')**
...
**35. maads.viperconsumergroupconsumefromtopic(vipertoken,host,port,topic,consumerid,groupid,companyname,enabletls=0,offset=0,
