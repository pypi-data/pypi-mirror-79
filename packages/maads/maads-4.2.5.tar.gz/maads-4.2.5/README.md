...
**24. maads.viperproducetotopic(vipertoken,host,port,topic,producerid,enabletls=0,inputdata='',maadsalgokey='',
...
**37. maads.vipermodifytopicdetails(vipertoken,host,port,topic,companyname,contactname='',contactemail='',
