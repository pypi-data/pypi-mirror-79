...
class Job(JobBase):
    ...
    __optional__ = ('name', 'filter', 'max_tries', 'diff_tool', 'additions_only', 'deletions_only',
                    'compared_versions', 'is_markdown', 'diff_filter')
...
class BrowserJob(Job):
    ...
    def main_thread_enter(self):
        ...
        self.ctx = BrowserContext(str(self.chromium_revision), proxy_server, self.ignore_http_error_codes,
