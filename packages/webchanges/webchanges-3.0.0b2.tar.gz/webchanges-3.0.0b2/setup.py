...
SETUP = {
    ...
    'project_urls': {'Bug Tracker': f'{project.__url__.rstrip("//")}/issues',
                     ...
                     'Documentation': f'https://{project.__project_name__}.readthedocs.io/en/stable/'}}
...
SETUP['extras_require']['testing'] = list(SETUP['extras_require']['testing'])
SETUP['extras_require']['all'] = list(set(pkg for extra in SETUP['extras_require'].values() for pkg in extra))
setup(**SETUP)
