...
class CfnGroup(
    ...
    def __init__(
        ...
        *,
        ...
        resource_query: typing.Optional[typing.Union["ResourceQueryProperty", aws_cdk.core.IResolvable]] = None,
    ...
    def resource_query(
        self,
    ) -> typing.Optional[typing.Union["ResourceQueryProperty", aws_cdk.core.IResolvable]]:
    ...
    def resource_query(
        self,
        value: typing.Optional[typing.Union["ResourceQueryProperty", aws_cdk.core.IResolvable]],
    ) -> None:
