...
class TreeItemResponse(Model):
    ...
    :ivar tree_item_type: Required.
    :vartype tree_item_type: str
    ...
    _validation = {
        'tree_item_type': {'required': True, 'readonly': True},
    ...
    def __init__(self, *, sort_order: int, id: str, name: str, active: bool, is_paused: bool, created, corporation, location, parent=None, children=None, hierarchy=None, abbreviation: str=None, **kwargs) -> None:
        super(TreeItemResponse, self).__init__(**kwargs)
        self.tree_item_type = None
