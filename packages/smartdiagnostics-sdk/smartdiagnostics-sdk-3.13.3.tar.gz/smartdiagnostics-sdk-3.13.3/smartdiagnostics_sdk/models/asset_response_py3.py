...
class AssetResponse(Model):
    ...
    def __init__(self, *, id: str, name: str, active: bool, is_paused: bool, created, corporation, location, supplier: str=None, manufacturer: str=None, model_name: str=None, location_notes: str=None, notes: str=None, generic_input: str=None, is_operator_view: bool=None, type=None, category=None, size=None, economics=None, running_speed=None, criticality=None, drum_roll=None, hierarchy=None, parent=None, children=None, tags=None, abbreviation: str=None, **kwargs) -> None:
