...
class PropertyChild(Model):
    ...
    :param property_value_type: Required.
    :type property_value_type: str
    ...
    def __init__(self, *, property_id: int, property_name: str, property_value_type: str, property_required: bool, property_value: str=None, property_description: str=None, **kwargs) -> None:
