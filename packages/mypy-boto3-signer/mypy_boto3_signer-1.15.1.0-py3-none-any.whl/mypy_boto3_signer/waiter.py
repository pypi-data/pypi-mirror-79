...
class SuccessfulSigningJobWaiter(Boto3Waiter):
    ...
    def wait(self, jobId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [SuccessfulSigningJob.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.15.1/reference/services/signer.html#Signer.Waiter.SuccessfulSigningJob.wait)
        """
