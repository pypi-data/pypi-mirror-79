...
class CfnDevice(
    ...
    def __init__(
        ...
        *,
        ...
        location: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "LocationProperty"]] = None,
    ...
    def location(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "LocationProperty"]],
    ) -> None:
