...
setuptools.setup(
    name="email-txt-classification", # Replace with your own username
    version="0.0.2",
    ...
    install_requires=["numpy==1.17.3","scikit-learn==0.23.1",
                      ...
                      "bert-tensorflow==1.0.1","keras==2.2.4","autoviml","typed-ast>=1.3.0","cntk",
                      "dask[complete]","requests==2.22.0","flask==1.1.1","joblib==0.16.0","dask-ml","bert-for-tf2","networkx","wordcloud"],
    classifiers=[
