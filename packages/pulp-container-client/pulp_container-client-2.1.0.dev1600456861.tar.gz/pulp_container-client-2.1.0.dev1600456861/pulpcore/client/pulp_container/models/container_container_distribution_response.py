...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, repository_version=None, repository=None, name=None, content_guard=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
