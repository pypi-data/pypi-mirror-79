...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_created=None, repository=None, pulp_href=None, base_path=None, name=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
