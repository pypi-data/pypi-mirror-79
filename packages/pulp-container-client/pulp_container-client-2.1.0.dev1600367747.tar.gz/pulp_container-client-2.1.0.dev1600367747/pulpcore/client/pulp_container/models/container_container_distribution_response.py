...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, repository=None, name=None, content_guard=None, pulp_created=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
