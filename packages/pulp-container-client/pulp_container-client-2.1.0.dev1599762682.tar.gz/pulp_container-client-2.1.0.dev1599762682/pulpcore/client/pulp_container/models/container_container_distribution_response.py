...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_created=None, content_guard=None, pulp_href=None, repository=None, base_path=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
