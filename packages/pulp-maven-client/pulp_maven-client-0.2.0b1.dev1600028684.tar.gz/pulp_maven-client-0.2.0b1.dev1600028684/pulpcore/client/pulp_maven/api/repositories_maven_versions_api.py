...
class RepositoriesMavenVersionsApi(object):
    ...
    def delete4(self, maven_maven_repository_version_href, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete4(maven_maven_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        return self.delete4_with_http_info(maven_maven_repository_version_href, **kwargs)  # noqa: E501

    def delete4_with_http_info(self, maven_maven_repository_version_href, **kwargs):  # noqa: E501
        """Delete a repository version  # noqa: E501

        Trigger an asynchronous task to delete a repositroy version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete4_with_http_info(maven_maven_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('maven_maven_repository_version_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `maven_maven_repository_version_href` when calling `delete4`")  # noqa: E501
    ...
    def list5(self, maven_maven_repository_href, **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

        MavenRepositoryVersion represents a single Maven repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list5(maven_maven_repository_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list5_with_http_info(maven_maven_repository_href, **kwargs)  # noqa: E501

    def list5_with_http_info(self, maven_maven_repository_href, **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

        MavenRepositoryVersion represents a single Maven repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list5_with_http_info(maven_maven_repository_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('maven_maven_repository_href' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `maven_maven_repository_href` when calling `list5`")  # noqa: E501
    ...
    def read5(self, maven_maven_repository_version_href, **kwargs):  # noqa: E501
        """Inspect a repository version  # noqa: E501

        MavenRepositoryVersion represents a single Maven repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read5(maven_maven_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read5_with_http_info(maven_maven_repository_version_href, **kwargs)  # noqa: E501

    def read5_with_http_info(self, maven_maven_repository_version_href, **kwargs):  # noqa: E501
        """Inspect a repository version  # noqa: E501

        MavenRepositoryVersion represents a single Maven repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read5_with_http_info(maven_maven_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('maven_maven_repository_version_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['maven_maven_repository_version_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `maven_maven_repository_version_href` when calling `read5`")  # noqa: E501
