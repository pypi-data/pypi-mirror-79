...
class WindowDicom:
	...
	def __call__(self, dicom_file, param_1, param_2):
		try:
			window_center , window_width, intercept, slope = self.get_windowing(dicom_file)
			img                                            = dicom_file.pixel_array
			dls                                            = self.window_image(img, param_1, param_2, intercept, slope)
		except Exception:
			raise Exception("Error with windowing the data. Please check your params and retry.")
