...
def delete_user_data(customer_name, customer_type):
    ...
    if db.get_customer_info_from_customer_name(customer_name):
        ...
        try:
            ...
            azure_move_directory(AZURE_INPUT_PATH + customer_type + '/' + customer_name + '/images/',
                                 "deletedUser/" + AZURE_INPUT_PATH + customer_type + '/' + customer_name + '/images/')
            ...
            azure_move_directory(AZURE_OUTPUT_PATH + customer_type + '/' + customer_name + '/images/',
                                 "deletedUser/" + AZURE_OUTPUT_PATH + customer_type + '/' + customer_name + '/images/')
            ...
            azure_move_directory(AZURE_VECTORS_PATH + customer_type + '/' + customer_name + '/images/',
                                 "deletedUser/" + AZURE_VECTORS_PATH + customer_type + '/' + customer_name + '/images/')
            ...
            azure_move_directory(AZURE_TRAINING_PATH + customer_type + '/' + customer_name + '/images/',
                                 "deletedUser/" + AZURE_TRAINING_PATH + customer_type + '/' + customer_name + '/images/')
