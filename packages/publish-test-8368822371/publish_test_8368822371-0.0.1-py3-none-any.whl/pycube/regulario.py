...
class RegularIO(State):
    ...
    def params_transformer(self, *args, **kwargs):
        return {index: arg for index, arg in enumerate(args)}
    ...
    def request(self, *args, **kwargs):
        ...
        kwargs["req"] = self._call_request(params, **{**kwargs, '__calltype__': 'request'})
        kwargs["pro"] = self._call_process(params, **{**kwargs, '__calltype__': 'response'})
