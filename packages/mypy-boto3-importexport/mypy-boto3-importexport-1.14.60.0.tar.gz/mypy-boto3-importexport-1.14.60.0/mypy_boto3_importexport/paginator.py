...
class ListJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.60/reference/services/importexport.html#ImportExport.Paginator.ListJobs.paginate)
        """
