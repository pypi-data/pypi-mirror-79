...
- Custom model image - use :meth:`~datarobot.Deployment.create_from_custom_model_image`. Please refer to :ref:`Custom Inference Image documentation <custom_inference_image>` on how to create a custom model image
