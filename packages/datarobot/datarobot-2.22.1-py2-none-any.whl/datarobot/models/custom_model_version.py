...
class CustomDependency(APIObject):
    ...
    def _set_values(self, package_name, constraints, line, line_number):
        ...
        self.constraints = [CustomDependencyConstraint.from_data(c) for c in constraints]
        self.line = line
...
class CustomModelVersion(APIObject):
    ...
    def _set_values(
        ...
        self.created_at = created_at
        self.dependencies = [CustomDependency.from_data(dep) for dep in dependencies or []]
    ...
    def create_clean(
        ...
        return cls._create(
            "post", custom_model_id, is_major_update, base_environment_id, folder_path, files,
        )
