...
.. _custom_inference_image_calculate_feature_impact:

Calculate Custom Inference Image feature impact
===============================================

To trigger calculation of Custom Inference Image feature impact, training data must be assigned to a Custom Inference Model.
...
.. code-block:: python
    ...
    image.calculate_feature_impact(max_wait=None)
...
To retrieve Custom Inference Image feature impact, it must be calculated beforehand.
Please refer to :ref:`Custom Inference Image feature impact documentation <custom_inference_image_calculate_feature_impact>`.
