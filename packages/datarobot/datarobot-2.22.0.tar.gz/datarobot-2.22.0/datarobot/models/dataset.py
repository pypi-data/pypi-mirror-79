...
class Dataset(APIObject):
    ...
    @classmethod
    def create_from_url(
        cls, url, do_snapshot=None, persist_data_after_ingestion=None, categories=None
    ):
        """
        ...
        new_dataset_location = wait_for_async_resolution(cls._client, response.headers["Location"])
    ...
    def create_project(
        self, project_name=None, user=None, password=None, credential_id=None, use_kerberos=None
    ):
        """
