...
if __name__ == '__main__':
    ...
    b = Bulk()
    b.prepare('update', 'update user set year=:year where username=:username')
    b.put('update', username='u3', year=32)
    b.put('update', username='u4', year=33)
    b.close()

    print (list(User.all()))

    b = Bulk()
    b.prepare('select', 'select * from user where username=:username')
    print (b.do_('select', username='u3').fetchone())

    b.prepare('delete', 'delete from user where username=:username')
    b.put('delete', username='u3')
    b.put('delete', username='u4')
    b.close()
    print (User.count())
