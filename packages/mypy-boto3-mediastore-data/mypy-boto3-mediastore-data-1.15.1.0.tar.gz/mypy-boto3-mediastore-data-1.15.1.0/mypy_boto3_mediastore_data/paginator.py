...
class ListItemsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListItems.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.15.1/reference/services/mediastore-data.html#MediaStoreData.Paginator.ListItems.paginate)
        """
