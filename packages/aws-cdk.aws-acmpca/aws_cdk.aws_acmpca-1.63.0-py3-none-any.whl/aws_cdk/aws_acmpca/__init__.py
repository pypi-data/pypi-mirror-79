...
class CfnCertificateAuthority(
    ...
    def __init__(
        ...
        *,
        ...
        type: str,
        revocation_configuration: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RevocationConfigurationProperty"]] = None,
    ...
    def revocation_configuration(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RevocationConfigurationProperty"]]:
    ...
    def revocation_configuration(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RevocationConfigurationProperty"]],
    ) -> None:
