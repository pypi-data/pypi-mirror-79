...
def cli():
    ...
    ignitioncreate_desc = 'Create Ignition'
    ignitioncreate_parser = create_subparsers.add_parser('ignition', description=ignitioncreate_desc,
                                                         help=ignitioncreate_desc)
    ignitioncreate_parser.add_argument('-f', '--inputfile', help='Input Plan file')
    ignitioncreate_parser.add_argument('-P', '--param', action='append',
                                       help='Define parameter for rendering (can specify multiple)', metavar='PARAM')
    ignitioncreate_parser.add_argument('--paramfile', help='Parameters file', metavar='PARAMFILE')
    ignitioncreate_parser.set_defaults(func=create_ignition)
