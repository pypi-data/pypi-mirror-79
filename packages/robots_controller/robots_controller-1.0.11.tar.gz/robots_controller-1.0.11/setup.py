...
def get_version():
    ...
    contents = read_file(os.path.join('robots_controller', '__init__.py'))
...
setup(
    name='robots_controller',
    version=get_version(),
    #version="0.0.3",
    url='https://gitlab.com/SamSafonov/robots_controller',
    license='BSD 1',
    ...
    entry_points={
        'console_scripts':['robots_controller = robots_controller.cli.main'],
    },
