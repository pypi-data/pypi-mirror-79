...
class V1Operation(BaseOp, TemplateMixinConfig, polyaxon_sdk.V1Operation):
    ...
    The [preset](/docs/management/ui/presets/) to use for this operation run,
    if provided, it will override the component's preset otherwise
    the preset of the component will be used if it exists.
