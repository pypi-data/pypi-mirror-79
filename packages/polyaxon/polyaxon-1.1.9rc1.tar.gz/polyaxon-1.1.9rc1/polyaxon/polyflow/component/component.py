...
class V1Component(
    ...
    The default component [preset](/docs/core/scheduling-strategies/presets/).

    This preset will be passed as the default value to all operations using this component,
    unless the operations override the preset or `--preset`
    is passed as an argument to the cli/client.
