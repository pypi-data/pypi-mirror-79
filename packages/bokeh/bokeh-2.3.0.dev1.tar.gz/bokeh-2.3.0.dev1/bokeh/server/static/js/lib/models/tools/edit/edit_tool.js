...
export class EditTool extends GestureTool {
    ...
    static init_EditTool() {
        this.define(({ Unknown, String, Array, Ref }) => ({
            custom_icon: [String],
    ...
    get tooltip() {
        var _a;
        return (_a = this.custom_tooltip) !== null && _a !== void 0 ? _a : this.tool_name;
    }
    get computed_icon() {
        var _a;
        return (_a = this.custom_icon) !== null && _a !== void 0 ? _a : this.icon;
    }
}
