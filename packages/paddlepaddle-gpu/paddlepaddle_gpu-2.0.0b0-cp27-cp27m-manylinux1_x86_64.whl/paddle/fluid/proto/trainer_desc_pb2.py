...
_TRAINERDESC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hogwild_param', full_name='paddle.framework.TrainerDesc.hogwild_param', index=31,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='downpour_param', full_name='paddle.framework.TrainerDesc.downpour_param', index=32,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pull_dense_param', full_name='paddle.framework.TrainerDesc.pull_dense_param', index=33,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='section_param', full_name='paddle.framework.TrainerDesc.section_param', index=34,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_desc', full_name='paddle.framework.TrainerDesc.data_desc', index=35,
