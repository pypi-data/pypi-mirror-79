...
_VARTYPE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOD_TENSOR', index=11, number=7,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SELECTED_ROWS', index=12, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEED_MINIBATCH', index=13, number=9,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FETCH_LIST', index=14, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STEP_SCOPES', index=15, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOD_RANK_TABLE', index=16, number=12,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOD_TENSOR_ARRAY', index=17, number=13,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PLACE_LIST', index=18, number=14,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='READER', index=19, number=15,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RAW', index=20, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TUPLE', index=21, number=18,
      options=None,
      type=None),
  ],
  containing_type=None,
