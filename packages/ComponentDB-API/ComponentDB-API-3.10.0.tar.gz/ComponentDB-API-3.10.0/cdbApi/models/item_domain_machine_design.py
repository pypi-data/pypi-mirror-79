...
class ItemDomainMachineDesign(object):
    ...
    def __init__(self, location=None, current_hierarchy_item_element=None, assigned_item=None, status_property_type_name=None, alternate_name=None, local_vars_configuration=None):  # noqa: E501
