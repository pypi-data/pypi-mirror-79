...
class ApplicationScalingAction(
    ...
    def __init__(
        self, step_scaling_action: aws_cdk.aws_applicationautoscaling.StepScalingAction
    ) -> None:
        """
    ...
    def bind(
        self, _scope: aws_cdk.core.Construct, _alarm: aws_cdk.aws_cloudwatch.IAlarm
...
class AutoScalingAction(
    ...
    def __init__(
        self, step_scaling_action: aws_cdk.aws_autoscaling.StepScalingAction
    ) -> None:
        """
        :param step_scaling_action: -
        """
...
@jsii.implements(aws_cdk.aws_cloudwatch.IAlarmAction)
class SnsAction(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudwatch-actions.SnsAction"
):
