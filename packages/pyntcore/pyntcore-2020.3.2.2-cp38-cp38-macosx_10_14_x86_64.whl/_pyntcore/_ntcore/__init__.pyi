...
class NetworkTableEntry():
    ...
    class Flags():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kPersistent': Flags.kPersistent}
        kPersistent: _pyntcore._ntcore.NetworkTableEntry.Flags # value = Flags.kPersistent
        pass
...
class NetworkTableType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    __members__: dict # value = {'kUnassigned': NetworkTableType.kUnassigned, 'kBoolean': NetworkTableType.kBoolean, 'kDouble': NetworkTableType.kDouble, 'kString': NetworkTableType.kString, 'kRaw': NetworkTableType.kRaw, 'kBooleanArray': NetworkTableType.kBooleanArray, 'kDoubleArray': NetworkTableType.kDoubleArray, 'kStringArray': NetworkTableType.kStringArray, 'kRpc': NetworkTableType.kRpc}
    kBoolean: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kBoolean
    kBooleanArray: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kBooleanArray
    kDouble: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kDouble
    kDoubleArray: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kDoubleArray
    kRaw: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kRaw
    kRpc: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kRpc
    kString: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kString
    kStringArray: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kStringArray
    kUnassigned: _pyntcore._ntcore.NetworkTableType # value = NetworkTableType.kUnassigned
    pass
class NetworkTablesInstance():
    ...
    class LogLevel():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kLogCritical': LogLevel.kLogCritical, 'kLogError': LogLevel.kLogError, 'kLogWarning': LogLevel.kLogWarning, 'kLogInfo': LogLevel.kLogInfo, 'kLogDebug': LogLevel.kLogDebug, 'kLogDebug1': LogLevel.kLogDebug1, 'kLogDebug2': LogLevel.kLogDebug2, 'kLogDebug3': LogLevel.kLogDebug3, 'kLogDebug4': LogLevel.kLogDebug4}
        kLogCritical: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogCritical
        kLogDebug: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogDebug
        kLogDebug1: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogDebug1
        kLogDebug2: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogDebug2
        kLogDebug3: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogDebug3
        kLogDebug4: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogDebug4
        kLogError: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogError
        kLogInfo: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogInfo
        kLogWarning: _pyntcore._ntcore.NetworkTablesInstance.LogLevel # value = LogLevel.kLogWarning
        pass
    class NetworkMode():
        """
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kNetModeNone': NetworkMode.kNetModeNone, 'kNetModeServer': NetworkMode.kNetModeServer, 'kNetModeClient': NetworkMode.kNetModeClient, 'kNetModeStarting': NetworkMode.kNetModeStarting, 'kNetModeFailure': NetworkMode.kNetModeFailure, 'kNetModeLocal': NetworkMode.kNetModeLocal}
        kNetModeClient: _pyntcore._ntcore.NetworkTablesInstance.NetworkMode # value = NetworkMode.kNetModeClient
        kNetModeFailure: _pyntcore._ntcore.NetworkTablesInstance.NetworkMode # value = NetworkMode.kNetModeFailure
        kNetModeLocal: _pyntcore._ntcore.NetworkTablesInstance.NetworkMode # value = NetworkMode.kNetModeLocal
        kNetModeNone: _pyntcore._ntcore.NetworkTablesInstance.NetworkMode # value = NetworkMode.kNetModeNone
        kNetModeServer: _pyntcore._ntcore.NetworkTablesInstance.NetworkMode # value = NetworkMode.kNetModeServer
        kNetModeStarting: _pyntcore._ntcore.NetworkTablesInstance.NetworkMode # value = NetworkMode.kNetModeStarting
        pass
