...
SERVICE_CATALOG = os.environ["SERVICE_CATALOG"]
...
class ParsedRequest:
    def __init__(self, request: Request):
        ...
        self.data = data
        self.repo = util.repo_name(data.get("wid"), data.get("cid"))
        self.change_ref = util.change_ref(
            data.get("sid"), self.user_info.get("user_id"), data.get("change_id")
        )
        self.plan_ref = util.plan_ref(
            data.get("sid"), self.user_info.get("user_id"), data.get("change_id")
        )
        self.apply_ref = self.apply_ref(data.get("sid"))
        self.source_apply_ref = self.apply_ref(data.get("source_sid"))
