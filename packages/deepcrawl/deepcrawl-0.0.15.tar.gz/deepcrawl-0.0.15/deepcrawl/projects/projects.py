...
class DeepCrawlProject(ImmutableAttributesMixin):
    ...
    def load_project_uploads(self, connection=None, filters=None, **kwargs):
    ...
    def create_project_upload(self, upload_data: dict, files, connection=None):
    ...
    def get_project_upload(self, project_upload_id, connection=None):
        """Get project upload
    ...
    def enable_project_upload(self, project_upload_id, connection=None):
    ...
    def disable_project_upload(self, project_upload_id, connection=None):
    ...
    def delete_project_upload(self, project_upload_id, connection=None):
    ...
    def get_project_uploads(self, use_cache=True, connection=None, filters=None, **kwargs):
        """Get project uploads for current instance

        * use_cache=True > get_project_uploads will return cached project uploads or will do a call to DeepCrawl if project_uploads attribute is empty.
