...
class ProjectConnection(ApiConnection):
    ...
    def create_project_upload(self, account_id, project_id, upload_data: dict, files):
        ...
        """
        endpoint_url = get_api_endpoint(endpoint="project_uploads", account_id=account_id, project_id=project_id)
    ...
    def get_project_upload(self, account_id, project_id, project_upload_id):
        """Get project upload
    ...
    def enable_project_upload(self, account_id, project_id, project_upload_id):
    ...
    def disable_project_upload(self, account_id, project_id, project_upload_id):
    ...
    def delete_project_upload(self, account_id, project_id, project_upload_id):
    ...
    def get_project_uploads(self, account_id, project_id, filters=None, **kwargs):
        """Get project uploads
        ...
        """
        endpoint_url = get_api_endpoint(endpoint='project_uploads', account_id=account_id, project_id=project_id)
        project_uploads = self.get_paginated_data(url=endpoint_url, method='get', filters=filters, **kwargs)
    ...
    def get_project_upload_types(self):
        endpoint_url = get_api_endpoint(endpoint='project_upload_types')
        return self.dc_request(url=endpoint_url, method='get').json()

    def get_project_upload_type(self, project_upload_type_code):
        endpoint_url = get_api_endpoint(
