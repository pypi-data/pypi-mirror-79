...
class ResolvedPhysicalProcess(Hdf5StudyPersistent, Stringifiable):
    """
    Simulation resolved physical process class

    Parameters
    ----------
    physics: ``:class:astrophysix.simdm.protocol.physics.PhysicalProcess``
        simulation code physical process instance (mandatory)
    details: ``string``
        physical process implementation details
    """
