...
from rdkit.Chem.rdchem import Mol, AtomKekulizeException

from reinvent_chemistry import TransformationTokens, Reactions
...
class ReactionSliceEnumerator:
    ...
    def enumerate(self, molecule: Mol, cuts: int):
        """
        ...
        for cut in range(1, cuts + 1):
            if cut == 1:
                ...
                for pair in fragment_pairs:
                    # print(f'all fragments: {len(pair)}')
