...
from  PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QToolButton, QSpacerItem, QSizePolicy, QGraphicsView, \
    QFrame, QApplication, QGraphicsObject, QGraphicsItem, QGraphicsScene, QGraphicsSceneMouseEvent, \
    QStyleOptionGraphicsItem
from PyQt5.QtCore import QSize, QCoreApplication, QRectF, Qt, QPointF
from PyQt5.QtGui import QIcon, QPixmap, QPen, QColor, QBrush, QPainter
