...
def plot_bar(plot_type,array,name_list_dict = None,legend = None,axis = None,ylabel = "Value",vmin = None,vmax = None,log_y = False,ncol = None,grid = None,tag = -1,save_path = None,show = False
...
def mesh(array,name_list_dict = None,axis_x = None,axis_y = None,clevs = None,cmap = None,ncol = None,tag = -1,save_path = None,show = False,dpi = 300,title =""):
    sup_fontsize = 10
    shape = array.shape
    if len(array[array != meteva.base.IV]) == 0:
        print("所有的值都为缺失值")
