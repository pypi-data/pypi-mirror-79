...
class CfnContainer(
    ...
    def __init__(
        ...
        *,
        container_name: str,
        access_logging_enabled: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]] = None,
        cors_policy: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CorsRuleProperty"]]]] = None,
        lifecycle_policy: typing.Optional[str] = None,
        metric_policy: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "MetricPolicyProperty"]] = None,
    ...
    def cors_policy(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CorsRuleProperty"]]]]:
    ...
    def cors_policy(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CorsRuleProperty"]]]],
    ) -> None:
    ...
    def metric_policy(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "MetricPolicyProperty"]]:
    ...
    def metric_policy(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "MetricPolicyProperty"]],
    ) -> None:
