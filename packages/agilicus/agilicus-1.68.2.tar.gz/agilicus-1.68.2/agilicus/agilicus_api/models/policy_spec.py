...
class PolicySpec(object):
    ...
    def __init__(self, name=None, issuer_id=None, org_id=None, supported_mfa_methods=None, default_action=None, rules=None, local_vars_configuration=None):  # noqa: E501
