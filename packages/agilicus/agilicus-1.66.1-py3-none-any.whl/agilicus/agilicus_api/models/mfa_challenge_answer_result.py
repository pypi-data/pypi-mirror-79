...
class MFAChallengeAnswerResult(object):
    ...
    def action(self):
        ...
        The action to take as a result of the question. do_mfa - the user should be challenged to present a second factor for authentication dont_mfa - the user does not need to present a second factor for authentication   # noqa: E501
    ...
    def action(self, action):
        ...
        allowed_values = ["do_mfa", "dont_mfa"]  # noqa: E501
