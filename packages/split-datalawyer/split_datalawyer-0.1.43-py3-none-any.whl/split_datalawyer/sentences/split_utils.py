...
abbreviations_file = os.path.join(os.path.dirname(__file__), "lista_abreviacoes.csv")
lista_abbreviacoes = pd.read_csv(abbreviations_file, sep=";", header=None)[0].values
punkt_param.abbrev_types = set(lista_abbreviacoes)
