...
class MagicBoxApi(object):
    ...
    def get_queuedcmd_currentindex(self, port_name, is_queued=False):
        return self.__dobotlink.MagicBox.GetQueuedCmdCurrentIndex(
            pportName=port_name, isQueued=is_queued)
    ...
    def get_posel(self, port_name, is_queued=False):
        return self.__dobotlink.MagicBox.GetPoseL(pportName=port_name,
                                                  isQueued=is_queued)
    ...
    def set_ptpwith_lcmd(self,
        ...
        return self.__dobotlink.MagicBoxLite.SetPTPWithLCmd(
            portName=port_name,
            l=set_l,
            isQueued=is_queued,
    ...
    def get_color_sensor(self, port_name, is_queued=False):
        return self.__dobotlink.MagicBox.GetColorSensor(pportName=port_name,
                                                        isQueued=is_queued)
    ...
    def get_jogl_params(self, port_name, is_queued=False):
        return self.__dobotlink.MagicBox.GetJOGLParams(pportName=port_name,
                                                       isQueued=is_queued)
