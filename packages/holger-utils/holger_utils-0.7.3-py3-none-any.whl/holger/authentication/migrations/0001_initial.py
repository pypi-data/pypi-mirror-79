...
import holger.authentication.utils.functions.user_pk_generator
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(default=holger.authentication.utils.functions.user_pk_generator.user_pk_generator, max_length=100, primary_key=True, serialize=False)),
                ...
                ('cellphone', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region='IR', unique=True, verbose_name='تلفن همراه')),
