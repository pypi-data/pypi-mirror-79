...
[boto3.CostandUsageReportService 1.15.0](https://boto3.amazonaws.com/v1/documentation/api/1.15.0/reference/services/cur.html#CostandUsageReportService) service
compatible with
