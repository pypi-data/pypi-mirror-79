...
class Cluster(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param control_plane_instance_type: control plane node ec2 instance type.
        :param spot_worker_nodes: Run worker nodes as EC2 Spot.
        :param vpc: VPC.
        :param worker_instance_type: worker node instance type.
