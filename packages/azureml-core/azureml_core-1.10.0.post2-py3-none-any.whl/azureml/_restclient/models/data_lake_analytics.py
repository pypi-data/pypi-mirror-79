...
class DataLakeAnalytics(Compute):
    ...
    :param properties:
    :type properties: ~_restclient.models.DataLakeAnalyticsProperties
    """
    ...
    def __init__(self, compute_location=None, description=None, resource_id=None, properties=None):
        super(DataLakeAnalytics, self).__init__(compute_location=compute_location, description=description, resource_id=resource_id)
