...
class RunDetailsDto(Model):
    ...
    def __init__(self, run_id=None, target=None, status=None, start_time_utc=None, end_time_utc=None, error=None, warnings=None, properties=None, input_datasets=None, run_definition=None, log_files=None):
