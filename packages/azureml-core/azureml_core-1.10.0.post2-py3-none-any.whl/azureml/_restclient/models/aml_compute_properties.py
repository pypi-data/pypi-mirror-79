...
class AmlComputeProperties(Model):
    ...
    :type vm_priority: str or ~_restclient.models.VmPriority
    ...
    :type user_account_credentials: ~_restclient.models.UserAccountCredentials
    ...
    :vartype allocation_state: str or ~_restclient.models.AllocationState
    ...
    :ivar node_state_counts: Node state counts. Counts of various node states
     on the compute.
    :vartype node_state_counts: ~_restclient.models.NodeStateCounts
    """
    ...
    def __init__(self, vm_size=None, vm_priority=None, scale_settings=None, user_account_credentials=None, subnet=None):
        super(AmlComputeProperties, self).__init__()
