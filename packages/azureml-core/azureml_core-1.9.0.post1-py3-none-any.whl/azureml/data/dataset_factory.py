    ...
    def from_json_lines_files(path,
        ...
        def invalid_lines_to_dprep_enum():
            if invalid_lines == 'error':
                ...
                raise ValueError('Expected \'error\' or \'drop\' as value for invalid_lines, found ' +
                                 str(invalid_lines))
        ...
        if invalid_lines != 'error':
            try:
                ...
                raise NotImplementedError('Unable to create azureml dataset from JSON lines files with ' +
