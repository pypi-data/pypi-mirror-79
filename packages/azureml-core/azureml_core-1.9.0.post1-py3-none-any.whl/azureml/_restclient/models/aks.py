...
class AKS(Compute):
    ...
    :type properties: ~_restclient.models.AKSProperties
    """
    ...
    def __init__(self, compute_location=None, description=None, resource_id=None, properties=None):
        super(AKS, self).__init__(compute_location=compute_location, description=description, resource_id=resource_id)
