...
class Workspace(Resource):
    ...
    :vartype identity: ~_restclient.models.Identity
    ...
    def __init__(self, location=None, tags=None, description=None, friendly_name=None, key_vault=None, application_insights=None, container_registry=None, storage_account=None, discovery_url=None):
