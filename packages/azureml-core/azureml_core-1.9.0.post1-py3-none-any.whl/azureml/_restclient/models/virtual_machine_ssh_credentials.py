...
class VirtualMachineSshCredentials(Model):
    ...
    :param passphrase: Passphrase for encrypted private key
    :type passphrase: str
    """
    ...
    def __init__(self, username=None, password=None, public_key_data=None, private_key_data=None, passphrase=None):
        super(VirtualMachineSshCredentials, self).__init__()
