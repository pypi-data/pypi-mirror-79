...
def create_workspace_private_endpoint(auth, resource_group_name, location, subscription_id, workspace_name,
    ...
    if orchestrator.error is not None:
        give_warning("UserWarning: The private endpoint resource creation failed. You can add private endpoint "
                     "to the workspace using 'workspace.add_private_endpoint()'. Error message: {}"
