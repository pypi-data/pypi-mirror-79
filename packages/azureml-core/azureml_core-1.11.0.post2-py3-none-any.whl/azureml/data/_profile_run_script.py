...
if __name__ == '__main__':
    ...
    saved_dataset_id = sys.argv[4]

    print('Start execution with action_id = {0}, dataset_id = {1}, dataflow_artifact_id = {2} and '
          'saved_dataset_id = {3}'.format(action_id, dataset_id, dataflow_artifact_id, saved_dataset_id))
