...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.22.0-alpha.1600159773+e1467b69'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.22.0-alpha.1600159773+e1467b69`
                """)
            else:
                raise
