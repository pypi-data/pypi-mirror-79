...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.21.0-alpha.1599833597+64c8614e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.21.0-alpha.1599833597+64c8614e`
                """)
            else:
                raise
