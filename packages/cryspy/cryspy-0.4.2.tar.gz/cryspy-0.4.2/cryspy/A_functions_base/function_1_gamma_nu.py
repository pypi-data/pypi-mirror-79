...
def gammanu_to_tthphi(gamma, nu):
    ...
    nu
        is the angle between equatorial plane and scattering neutron [-pi/2, pi/2]
...
def recal_int_to_tthphi_grid(l_gamma_grid, l_nu_grid, ll_int_grid, l_ttheta_grid, l_phi_grid):
    l_point = []
...
def recal_int_to_gammanu_grid(ltth_grid, l_phi_grid, ll_int_grid, l_gamma_grid, l_nu_grid):
    l_point = []
    for nu in l_nu_grid:
