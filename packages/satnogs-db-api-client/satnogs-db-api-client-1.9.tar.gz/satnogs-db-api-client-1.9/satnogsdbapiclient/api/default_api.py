...
class DefaultApi(object):
    ...
    def list_latest_tles(self, **kwargs):  # noqa: E501
        """list_latest_tles  # noqa: E501

        SatNOGS DB Tle API view class  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_latest_tles(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_latest_tles_with_http_info(**kwargs)  # noqa: E501

    def list_latest_tles_with_http_info(self, **kwargs):  # noqa: E501
        """list_latest_tles  # noqa: E501
        ...
        >>> thread = api.list_latest_tles_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_latest_tles" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def retrieve_latest_tle(self, id, **kwargs):  # noqa: E501
        """retrieve_latest_tle  # noqa: E501

        SatNOGS DB Tle API view class  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.retrieve_latest_tle(id, async_req=True)
        >>> result = thread.get()

        :param id: A unique integer value identifying this latest tle. (required)
        :type id: str
        :param norad_cat_id: norad_cat_id
        :type norad_cat_id: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.retrieve_latest_tle_with_http_info(id, **kwargs)  # noqa: E501

    def retrieve_latest_tle_with_http_info(self, id, **kwargs):  # noqa: E501
        """retrieve_latest_tle  # noqa: E501
        ...
        >>> thread = api.retrieve_latest_tle_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method retrieve_latest_tle" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `retrieve_latest_tle`")  # noqa: E501
