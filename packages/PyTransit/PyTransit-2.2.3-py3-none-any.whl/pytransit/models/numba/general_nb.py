...
from pytransit.orbits.taylor_z import vajs_from_paiew, z_taylor_v
...
def general_model_v(t: ndarray, k: ndarray, t0: ndarray, p: ndarray, a: ndarray, i: ndarray, e: ndarray, w: ndarray, ldc: ndarray,
                    ...
                    npb: int, npol: int, nldc: int, anm: ndarray, avl: ndarray, ajd: ndarray, aje: ndarray):
    ...
    for ipv in prange(npv):
        ...
        for ilc in range(nlcs):
            ...
            for isample in range(1, nsamples[ilc] + 1):
                ...
                z = z_taylor_v(tlc + time_offset, t0[ipv], p[ipv], y0, vx, vy, ax, ay, jx, jy, sx, sy)
