            ...
            if recv_data_lst:
                for client_with_message in recv_data_lst:
                    try:
                        ...
                        LOGGER.debug('Getting data from client exception.',
                                     exc_info=err)
