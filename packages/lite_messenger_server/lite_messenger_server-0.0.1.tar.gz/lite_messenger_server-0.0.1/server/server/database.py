...
class ServerStorage:
    ...
    def __init__(self, path):
        ...
        # pool_recycle - По умолчанию соединение с БД
        # через 8 часов простоя обрывается.
        ...
        # Когда устанавливаем соединение,
    ...
    def user_login(self, username, ip_address, port, key):
        ...
        записывает в базу факт входа Обновляет открытый
        ключ пользователя при его изменении.
        """
...
if __name__ == '__main__':
    database_file = "../server_base.db3"
    test_db = ServerStorage(database_file)
    # выполняем 'подключение' пользователя
    test_db.user_login('Dmitrii', '192.168.1.4', 8888, 'key')
    test_db.user_login('Aleks', '192.168.1.5', 7777, 'key')
    test_db.user_login('McG2', '192.168.1.113', 8081, 'key')
    print(test_db.users_list())
    # выводим список кортежей - активных пользователей
    print(test_db.active_users_list())
    # выполянем 'отключение' пользователя
    test_db.user_logout('Dmitrii')
    # выводим список активных пользователей
    print(test_db.active_users_list())
    # запрашиваем историю входов по пользователю
    test_db.login_history('Dmitrii')
    ...
    test_db.process_message('Dmitrii', 'Aleks')
