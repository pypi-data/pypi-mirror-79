...
class Liuren():
    ...
    def result_html(self, num):
        ...
        layer_four = '''<tr><td style="vertical-align:bottom" align="right">'''+"".join([ '''{}<br>'''.format(k) for k in list(su[11])])+'''{}<br>'''.format(general[11]) + '''{}<br>'''.format(sky[11])+"</td><td>&emsp;</td><td>&emsp;</td></tr>" +  '''<td style="vertical-align:bottom" align="right">'''+'''{}<br>'''.format(sky[4]) + '''{}<br>'''.format(general[4])+"".join([ '''{}<br>'''.format(k) for k in list(su[4])])+"</td></tr>"
        layer_five = '''<tr><td style="vertical-align:bottom" align="right">'''+"".join([ '''{}<br>'''.format(k) for k in list(su[10])])+'''{}<br>'''.format(general[10]) + '''{}<br>'''.format(sky[10])+"</td><td>&emsp;</td><td>&emsp;</td></tr>" +  '''<td style="vertical-align:bottom" align="right">'''+'''{}<br>'''.format(sky[5]) + '''{}<br>'''.format(general[5])+"".join([ '''{}<br>'''.format(k) for k in list(su[5])])+"</td></tr>"
