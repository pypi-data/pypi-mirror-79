...
class Liuren():
    ...
    def result_html(self, num):
        ...
        layer_four = '''<tr><td style="vertical-align:bottom" align="left">'''+"".join([ '''{}'''.format(k) for k in list(su[11])])+'''{}'''.format(general[11]) + '''{}'''.format(sky[11])+"</td><td>&emsp;</td><td>&emsp;</td>" +  '''<td style="vertical-align:bottom" align="right">'''+'''{}'''.format(sky[4]) + '''{}'''.format(general[4])+"".join([ '''{}'''.format(k) for k in list(su[4])])+"</td></tr>"
        layer_five = '''<tr><td style="vertical-align:bottom" align="left">'''+"".join([ '''{}'''.format(k) for k in list(su[10])])+'''{}'''.format(general[10]) + '''{}'''.format(sky[10])+"</td><td>&emsp;</td><td>&emsp;</td>" +  '''<td style="vertical-align:bottom" align="right">'''+'''{}'''.format(sky[5]) + '''{}'''.format(general[5])+"".join([ '''{}'''.format(k) for k in list(su[5])])+"</td></tr>"
