...
def release():
    ...
    command = 'git merge --no-ff {branch} -m {message}'.format(branch=branch, message=message)
    log.debug(command)
    os.system(command)
    ...
    command = 'git merge --no-ff {branch} -m {message}'.format(branch=branch, message=message_noci)
    log.debug(command)
    os.system(command)
