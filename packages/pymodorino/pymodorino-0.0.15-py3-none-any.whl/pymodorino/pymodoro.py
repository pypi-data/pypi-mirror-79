...
from pymodorino.utils import getFormattedTime, minutesToSeconds, printMessage, InputBuffer, resource_path
...
notification = Notify(
    ...
    default_notification_icon= resource_path("./pymodorino/pomodorino.png"),
    default_notification_audio= resource_path("./pymodorino/oi.wav")
)
