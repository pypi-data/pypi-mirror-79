...
class dataflow_reader(object):
    ...
    def get_blob_sas(self, blob_name):
        ...
        sas_generator = BlobSharedAccessSignature(self._storage_account_name, account_key = self._storage_account_key)
        return sas_generator.generate_blob(self._container_name, 
            blob_name, 
